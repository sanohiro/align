...
fn shape_spec(shape: RuntimeAbiShape) -> RuntimeAbiShapeSpec {
    match shape {
        ...
        RuntimeAbiShape::A11 => RuntimeAbiShapeSpec {
            ret: NativeReturn::I32,
            params: &[
                NativeType::Ptr,
                NativeType::I64,
        ...
        RuntimeAbiShape::A14 => RuntimeAbiShapeSpec {
            ret: NativeReturn::I32,
            params: &[
                NativeType::Ptr,
                NativeType::I64,
