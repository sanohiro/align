...
pub(super) enum UnkeyedRuntimeKey {
    ...
    TestAckV1 = 15,
    TestReportV1 = 16,
    TcpConnSetIoTimeout = 17,
}

pub(super) const UNKEYED_RUNTIME_KEYS: [UnkeyedRuntimeKey; 18] = [
    ...
    UnkeyedRuntimeKey::TcpConnSetIoTimeout,
];
...
pub(super) fn runtime_abi(key: RuntimeKey) -> RuntimeAbi {
    ...
    match runtime_key {
        ...
        RuntimeKey::JsonBuilderFinish => RuntimeAbi {
            key,
            symbol: "align_rt_json_builder_finish",
            shape: RuntimeAbiShape::A128,
        },
        ...
        RuntimeKey::CommandNewSession => RuntimeAbi { key, symbol: "align_rt_command_new_session", shape: RuntimeAbiShape::A131 },
        RuntimeKey::CommandStdoutTo => RuntimeAbi { key, symbol: "align_rt_command_stdout_to", shape: RuntimeAbiShape::A19 },
        RuntimeKey::CommandStderrTo => RuntimeAbi { key, symbol: "align_rt_command_stderr_to", shape: RuntimeAbiShape::A19 },
        RuntimeKey::CommandStart => RuntimeAbi { key, symbol: "align_rt_command_start", shape: RuntimeAbiShape::A19 },
        RuntimeKey::ChildId => RuntimeAbi { key, symbol: "align_rt_child_id", shape: RuntimeAbiShape::A29 },
        RuntimeKey::ChildStatus => RuntimeAbi { key, symbol: "align_rt_child_status", shape: RuntimeAbiShape::A19 },
        RuntimeKey::ChildTryWait => RuntimeAbi { key, symbol: "align_rt_child_try_wait", shape: RuntimeAbiShape::A19 },
        RuntimeKey::ChildReadStdout => RuntimeAbi { key, symbol: "align_rt_child_read_stdout", shape: RuntimeAbiShape::A22 },
        RuntimeKey::ChildReadStderr => RuntimeAbi { key, symbol: "align_rt_child_read_stderr", shape: RuntimeAbiShape::A22 },
        RuntimeKey::ChildPoll => RuntimeAbi { key, symbol: "align_rt_child_poll", shape: RuntimeAbiShape::A132 },
        RuntimeKey::ChildKillGroup => RuntimeAbi { key, symbol: "align_rt_child_kill_group", shape: RuntimeAbiShape::A04 },
        RuntimeKey::ChildGroupMembers => RuntimeAbi { key, symbol: "align_rt_child_group_members", shape: RuntimeAbiShape::A08 },
        RuntimeKey::RunOutputStatus => RuntimeAbi { key, symbol: "align_rt_run_output_status", shape: RuntimeAbiShape::A72 },
        RuntimeKey::RunBytesStatus => RuntimeAbi { key, symbol: "align_rt_run_bytes_status", shape: RuntimeAbiShape::A72 },
        RuntimeKey::ProcessSignalNumber => RuntimeAbi { key, symbol: "align_rt_process_signal_number", shape: RuntimeAbiShape::A133 },
        RuntimeKey::ProcessSignals => RuntimeAbi { key, symbol: "align_rt_process_signals", shape: RuntimeAbiShape::A134 },
        RuntimeKey::ProcessSignalNext => RuntimeAbi { key, symbol: "align_rt_process_signal_next", shape: RuntimeAbiShape::A19 },
        RuntimeKey::ProcessSignalClose => RuntimeAbi { key, symbol: "align_rt_process_signal_close", shape: RuntimeAbiShape::A03 },
        RuntimeKey::ProcessSignalFree => RuntimeAbi { key, symbol: "align_rt_process_signal_free", shape: RuntimeAbiShape::A62 },
        RuntimeKey::FsMemoryFile => RuntimeAbi { key, symbol: "align_rt_fs_memory_file", shape: RuntimeAbiShape::A135 },
        RuntimeKey::FsMemoryWrite => RuntimeAbi { key, symbol: "align_rt_fs_memory_write", shape: RuntimeAbiShape::A20 },
        RuntimeKey::FsMemorySeal => RuntimeAbi { key, symbol: "align_rt_fs_memory_seal", shape: RuntimeAbiShape::A19 },
        RuntimeKey::FsMemoryFree => RuntimeAbi { key, symbol: "align_rt_fs_memory_free", shape: RuntimeAbiShape::A62 },
        RuntimeKey::FsSealedLen => RuntimeAbi { key, symbol: "align_rt_fs_sealed_len", shape: RuntimeAbiShape::A29 },
        RuntimeKey::FsSealedReadAt => RuntimeAbi { key, symbol: "align_rt_fs_sealed_read_at", shape: RuntimeAbiShape::A12 },
        RuntimeKey::FsSealedFree => RuntimeAbi { key, symbol: "align_rt_fs_sealed_free", shape: RuntimeAbiShape::A62 },
        RuntimeKey::ProcessExecutable => RuntimeAbi { key, symbol: "align_rt_process_executable", shape: RuntimeAbiShape::A19 },
        RuntimeKey::ProcessImageLen => RuntimeAbi { key, symbol: "align_rt_process_image_len", shape: RuntimeAbiShape::A29 },
        RuntimeKey::ProcessImageReadAt => RuntimeAbi { key, symbol: "align_rt_process_image_read_at", shape: RuntimeAbiShape::A12 },
        RuntimeKey::ProcessImageFree => RuntimeAbi { key, symbol: "align_rt_process_image_free", shape: RuntimeAbiShape::A62 },
        RuntimeKey::CommandImage => RuntimeAbi { key, symbol: "align_rt_command_image", shape: RuntimeAbiShape::A22 },
        RuntimeKey::ProcessCurrentImage => RuntimeAbi { key, symbol: "align_rt_process_current_image", shape: RuntimeAbiShape::A03 },
        RuntimeKey::ProcessUserNamespace => RuntimeAbi { key, symbol: "align_rt_process_user_namespace", shape: RuntimeAbiShape::A08 },
        ...
        RuntimeKey::FrameInnerJoinI64V1 => RuntimeAbi {
            key,
            symbol: "align_rt_frame_inner_join_i64_v1",
            shape: RuntimeAbiShape::A121,
        },
        RuntimeKey::FrameInnerJoinStrV1 => RuntimeAbi {
            key,
            symbol: "align_rt_frame_inner_join_str_v1",
            shape: RuntimeAbiShape::A122,
        },
        RuntimeKey::CsvDecodeSoaV1 => RuntimeAbi {
            key,
            symbol: "align_rt_csv_decode_soa_v1",
            shape: RuntimeAbiShape::A123,
        },
        ...
        RuntimeKey::FsCreatePrivateTempDir => RuntimeAbi {
            key,
            symbol: "align_rt_fs_create_private_temp_dir",
            shape: RuntimeAbiShape::A08,
        },
        ...
        RuntimeKey::FsCreateDir => RuntimeAbi { key, symbol: "align_rt_fs_create_dir", shape: RuntimeAbiShape::A04 },
        RuntimeKey::FsIsDir => RuntimeAbi { key, symbol: "align_rt_fs_is_dir", shape: RuntimeAbiShape::A08 },
        RuntimeKey::FsRemoveEmptyDir => RuntimeAbi {
            key,
            symbol: "align_rt_fs_remove_empty_dir",
            shape: RuntimeAbiShape::A04,
        },
        ...
        RuntimeKey::HttpHeadersContainsTokenExact => RuntimeAbi {
            key,
            symbol: "align_rt_http_headers_contains_token_exact",
            shape: RuntimeAbiShape::A120,
        },
        ...
        RuntimeKey::IoReaderOpenRegular => RuntimeAbi {
            key,
            symbol: "align_rt_io_reader_open_regular",
            shape: RuntimeAbiShape::A08,
        },
        ...
        RuntimeKey::IoReaderOpenBeneathSingleLink => RuntimeAbi {
            key,
            symbol: "align_rt_io_reader_open_beneath_single_link",
            shape: RuntimeAbiShape::A12,
        },
        ...
        RuntimeKey::LogEnabled => RuntimeAbi {
            key,
            symbol: "align_rt_log_enabled",
            shape: RuntimeAbiShape::A115,
        },
        RuntimeKey::LogFlush => RuntimeAbi {
            key,
            symbol: "align_rt_log_flush",
            shape: RuntimeAbiShape::A03,
        },
        RuntimeKey::LogFree => RuntimeAbi {
            key,
            symbol: "align_rt_log_free",
            shape: RuntimeAbiShape::A62,
        },
        RuntimeKey::LogLine => RuntimeAbi {
            key,
            symbol: "align_rt_log_line",
            shape: RuntimeAbiShape::A116,
        },
        RuntimeKey::LogLineBuilder => RuntimeAbi {
            key,
            symbol: "align_rt_log_line_builder",
            shape: RuntimeAbiShape::A117,
        },
        RuntimeKey::LogNew => RuntimeAbi {
            key,
        ...
        RuntimeKey::TemplateHtmlFree => RuntimeAbi {
            key,
            symbol: "align_rt_template_html_free_v1",
            shape: RuntimeAbiShape::A62,
        },
        RuntimeKey::TemplateHtmlNew => RuntimeAbi {
            key,
            symbol: "align_rt_template_html_new_v1",
            shape: RuntimeAbiShape::A47,
        },
        RuntimeKey::TemplateHtmlRaw => RuntimeAbi {
            key,
            symbol: "align_rt_template_html_raw_v1",
            shape: RuntimeAbiShape::A73,
        },
        RuntimeKey::TemplateHtmlToString => RuntimeAbi {
            key,
            symbol: "align_rt_template_html_into_string_v1",
            shape: RuntimeAbiShape::A83,
        },
        RuntimeKey::TemplateHtmlWrite => RuntimeAbi {
            key,
            symbol: "align_rt_template_html_write_v1",
            shape: RuntimeAbiShape::A73,
        },
        ...
        RuntimeKey::TimeFormat => RuntimeAbi {
            key,
            symbol: "align_rt_time_format",
            shape: RuntimeAbiShape::A124,
        },
        RuntimeKey::TimeParse => RuntimeAbi {
            key,
            symbol: "align_rt_time_parse",
            shape: RuntimeAbiShape::A125,
        },
        RuntimeKey::PercentEncodePath => RuntimeAbi {
            key,
            symbol: "align_rt_percent_encode_path",
            shape: RuntimeAbiShape::A84,
        },
...
pub(super) fn unkeyed_runtime_abi(key: UnkeyedRuntimeKey) -> RuntimeAbi {
    ...
    match key {
        ...
        UnkeyedRuntimeKey::TcpConnSetIoTimeout => RuntimeAbi {
            key: id,
            symbol: "align_rt_tcp_conn_set_io_timeout",
            shape: RuntimeAbiShape::A04,
        },
    }
}
    ...
    match shape {
        ...
        RuntimeAbiShape::A128 | RuntimeAbiShape::A129 | RuntimeAbiShape::A130 => {
            let base = match shape {
                RuntimeAbiShape::A128 => RuntimeAbiShape::A19,
