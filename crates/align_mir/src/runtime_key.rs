...
macro_rules! runtime_keys {
    ($($variant:ident => $logical:literal,)*) => {
        ...
        impl RuntimeKey {
            pub const ALL: [Self; 446] = [$(Self::$variant,)*];
...
runtime_keys! {
    ...
    BufferAppendFilled => "buffer_append_filled",
    BufferBytes => "buffer_bytes",
    BufferCapacity => "buffer_capacity",
    BufferFilled => "buffer_filled",
    ...
    CryptoDigestFinish => "crypto_digest_finish",
    CryptoDigestFree => "crypto_digest_free",
    CryptoDigestNew => "crypto_digest_new",
    CryptoDigestUpdate => "crypto_digest_update",
    ...
    CsvDecodeSoaV1 => "csv_decode_soa_v1",
    ...
    FrameInnerJoinI64V1 => "frame_inner_join_i64_v1",
    FrameInnerJoinStrV1 => "frame_inner_join_str_v1",
    Free => "free",
    ...
    PercentEncodePath => "percent_encode_path",
    Print => "print",
    ...
    TemplateHtmlFree => "template_html_free",
    TemplateHtmlNew => "template_html_new",
    TemplateHtmlRaw => "template_html_raw",
    TemplateHtmlToString => "template_html_to_string",
    TemplateHtmlWrite => "template_html_write",
    TgAlloc => "tg_alloc",
    TgBegin => "tg_begin",
    TgEnd => "tg_end",
...
const _: [(); 446] = [(); RuntimeKey::ALL.len()];
...
mod tests {
    ...
    fn runtime_keys_are_complete_unique_and_alphabetical() {
        assert_eq!(RuntimeKey::ALL.len(), 446);
