...
mod tests {
    ...
    fn generated_identity_codec() {
        let unit = ty("030000000038");
        let bool_ty = ty("030000000002");
        let i64_ty = ty("0300000000000140");
        let slice_i64 = ty("03000000000d000140");
        let empty_abi = abi("0100000000030000000038000000");
        let i64_abi = abi("01010000000003000000000001400300000000000140000000");
        ...
        for mode in [
            ...
            roundtrip(GeneratedId::Parallel(ParallelGeneratedId {
                ...
                terminal_abi: abi("0100000000030000000038000000"),
    ...
    fn generated_identity_error_precedence() {
        ...
        let invalid_parallel = GeneratedId::Parallel(ParallelGeneratedId {
            ...
            source: ty("030000000038"),
            terminal_input: ty("030000000038"),
            terminal_output: ty("030000000038"),
            terminal: call("f"),
            terminal_abi: abi("0100000000030000000038000000"),
            terminal_captures: vec![],
            stages: vec![],
