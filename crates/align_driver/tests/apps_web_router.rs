...
pub fn get(pattern: str, handler: fn(pkg.web.types.Ctx) -> Result<response_builder, Error>) -> pkg.web.types.Route =\n\
  pkg.web.types.Route { method: \"GET\", prefix: \"\", pattern: pattern, middleware: None, stream_type: \"\", handler: pkg.web.types.Handler.Respond(handler), upgrade_values: [] }\n\
pub fn post(pattern: str, handler: fn(pkg.web.types.Ctx) -> Result<response_builder, Error>) -> pkg.web.types.Route =\n\
  pkg.web.types.Route { method: \"POST\", prefix: \"\", pattern: pattern, middleware: None, stream_type: \"\", handler: pkg.web.types.Handler.Respond(handler), upgrade_values: [] }\n\
