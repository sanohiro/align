...
pub const INLINE_BODY_POLICY_VERSION: u32 = 3;
...
const BUILTIN_CAPABILITIES: &[(&str, usize, BuiltinCapability)] = &[
    ...
    ("process.user_namespace", 0, BuiltinCapability::Opaque),
    ("fs.memory_kind", 0, BuiltinCapability::Opaque),
    ...
    ("http_response", 0, BuiltinCapability::Opaque),
