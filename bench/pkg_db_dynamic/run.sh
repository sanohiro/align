#!/usr/bin/env bash
# D14 dynamic-SQL row-materialization measurement.
set -euo pipefail
...
echo "rows=10000"
echo "record order: sqlite-first, sqlite-scan, postgres-first, postgres-scan"
echo "fields per record: elapsed_ns, allocations, frees, rows, checksum"
