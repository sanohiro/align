...
| `public-surface-completeness` | 3 | 3 | Three-plus events: the interface owner now keeps builtin nominal spellings, ownership classes, required source imports, and public-signature reconstruction synchronized; package exports still require an exact ledger comparison and internal/sealed boundary for cross-module helpers. |
