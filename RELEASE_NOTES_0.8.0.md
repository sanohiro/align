# Align v0.8.0 Release Notes

Align v0.8.0 collects the language, compiler, standard-library, and reliability work shipped since v0.7.5. Align remains pre-release; rebuild programs and libraries with the matching compiler and runtime archive.
