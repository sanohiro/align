...
arguments remain excluded. [Request 61’s contract](docs/impl/37-borrowed-buffer-writer-plan.md) owns receiver validation and closure.
...
[host observation](docs/impl/42-host-observation-plan.md).
