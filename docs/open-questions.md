...
### S3 explicit-expiry presigning — design candidate 2026-09-09

The proposed additional contract is `docs/impl/pkg-design/s3-presign.md`.
...
records. Independent design review must accept this candidate before implementation;
no language or existing header-authentication decision is reopened.
