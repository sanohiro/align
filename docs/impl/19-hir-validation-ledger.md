...
| move/replacement, self-assignment, cleanup, staged action, and control joins | `borrow_liveness::storage_generation_move_replacement_cleanup_control_matrix`; `return_provenance::storage_generation_move_replacement_escape_matrix` |
