...
- [json.md](json.md) — `json.encode` / `json.encode_bounded` / `json.decode`(struct / array / soa ターゲット)、エラー方針、ゼロコピービュー
...
- [test.md](test.md) — 設計済み `core.test` declaration/assertion、isolated runner protocol、terse-output policy（implementation pending）
