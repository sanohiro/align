...
The implementation closure matrix was re-opened again around the complete artifact-formation-to-
execution mode and ABI product: production/test mode selection, executable entry identity,
database preparation reachability, child runtime reporting, option consumers, and runner diagnostic
operations. This retains the prior statement-placement, terminal-target, finalization,
capture/control I/O-liveness, and semantic side-table closures. The accepted code
