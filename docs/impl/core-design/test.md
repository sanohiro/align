...
The implementation closure matrix was re-opened again around complete capture/control I/O liveness
and semantic side-table identity. This retains the prior statement-placement, terminal-target, and
finalization closures. The accepted code
