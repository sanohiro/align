...
matrix in `pkg-design/s3-presign.md` is independently reviewed and accepted;
next is its complete implementation. It returns owned method/URL/required headers without a body or
