...
| ABI/cache | ten keys と reused shape の exact empty curated function-attribute set、native query hard-abort、checked `SO_NOSIGPIPE` accept failure、HIR/MIR/LLVM、direct runtime/subprocess、rt-LTO、whole/per-unit、edit/revert、vendored inventory。 |
