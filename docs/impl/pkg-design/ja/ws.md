...
| ownership | rb/fd/ctx move、publication、replacement、Result/pump move、`?`/else/match/map_err/branch/loop/early exit/Drop、fd/allocation counter。 |
