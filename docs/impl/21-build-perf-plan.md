...
10 W13 captured-child lease and `SIGCHLD` disposition, pipe/group/spawn setup,
   child-output sink return/panic or status/poll/read result, mandatory process-
   group quiescence, child reap when waitable, lease release, resumed sink panic
   or link and publication
