...
`apps/web/pkg`, `apps/frame/pkg`, `apps/auth/pkg`, `apps/db/pkg`, and
`apps/kv/pkg`. A consumer receives a hit only for byte-identical reachable units
