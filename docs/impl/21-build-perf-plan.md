...
10 W13 captured-child lease and `SIGCHLD` disposition, pipe/group/spawn setup,
   child-output sink/status/poll/read result, mandatory process-group quiescence,
   child reap when waitable, lease release, link, and publication
