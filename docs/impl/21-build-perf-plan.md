...
and deliberately detached descendants may continue briefly, and W13's internal
...
- the child sees only a randomized tool-output stage. After successful child
  cleanup, W13 copies it into a distinct unexposed publication stage and accepts
