...
**Accepted nominal-alias extension (designed 2026-08-30; implementation pending).** The asymmetric
...
`std.crypto`. The crypto implementation expands the parameterized sema/interface owner rather than
