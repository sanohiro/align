...
db_list="llvm-22-dev clang-22 libclang-rt-22-dev libpq-dev libsqlite3-dev libssl-dev zlib1g-dev libzstd-dev make perl"
reversed_list="perl make libzstd-dev zlib1g-dev libssl-dev libsqlite3-dev libpq-dev libclang-rt-22-dev clang-22 llvm-22-dev"
lint_list="llvm-22-dev clang-22 libclang-rt-22-dev libssl-dev zlib1g-dev libzstd-dev make perl"
