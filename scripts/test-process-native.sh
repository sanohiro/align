...
scripts/cargo.sh test -p align_driver --locked --test m11_process --test m11_process_command --test m11_process_live --test m11_process_signals --test m11_process_verified
