...
implementation head is `2f0c7b5`, with the expected-seed and return-spelling repair reopened. The earlier
...
Align PR #704 is pushed through `2f0c7b5`; preflight and final attestations are still
...
- In progress: final review at `2f0c7b5` found two new P2s. The host review found concrete expected-return leaf mismatches are still deferred until after argument checking; the independent review found an annotated scanner return spelling is lost for a generic call with no scanner argument. The closure matrix is reopened for both boundaries. The host and independent findings are not yet repaired.
