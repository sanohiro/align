...
define i32 @main() #0 {
bb0:
  %_0 = alloca %Point, align 4
  %fldptr = getelementptr inbounds %Point, ptr %_0, i32 0, i32 0
  store i32 3, ptr %fldptr, align 4
  %fldptr1 = getelementptr inbounds %Point, ptr %_0, i32 0, i32 1
  store i32 4, ptr %fldptr1, align 4
  %fldptr2 = getelementptr inbounds %Point, ptr %_0, i32 0, i32 1
  store i32 10, ptr %fldptr2, align 4
  %fldptr3 = getelementptr inbounds %Point, ptr %_0, i32 0, i32 0
  %fld = load i32, ptr %fldptr3, align 4
  %sext = sext i32 %fld to i64
  call void @align_rt_print_i64(i64 %sext)
  %fldptr4 = getelementptr inbounds %Point, ptr %_0, i32 0, i32 1
  %fld5 = load i32, ptr %fldptr4, align 4
  %sext6 = sext i32 %fld5 to i64
  call void @align_rt_print_i64(i64 %sext6)
  %fldptr7 = getelementptr inbounds %Point, ptr %_0, i32 0, i32 0
  %fld8 = load i32, ptr %fldptr7, align 4
  %fldptr9 = getelementptr inbounds %Point, ptr %_0, i32 0, i32 1
  %fld10 = load i32, ptr %fldptr9, align 4
  %add = add i32 %fld8, %fld10
  ret i32 %add
}
