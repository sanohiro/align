...
bb0:
  ...
  %call = call double @sqrt(double 1.600000e+01)
  store double %call, ptr %_0, align 8
  %call1 = call double @cbrt(double 2.700000e+01)
  store double %call1, ptr %_1, align 8
  %load = load double, ptr %_0, align 8
  %load2 = load double, ptr %_1, align 8
  %fadd = fadd double %load, %load2
  %intr = call i32 @llvm.fptosi.sat.i32.f64(double %fadd)
  ret i32 %intr
}
