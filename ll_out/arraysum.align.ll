...
define i32 @main() #0 {
bb0:
  %_0 = alloca [3 x i32], align 4
  %_1 = alloca i32, align 4
  %_2 = alloca i64, align 8
  %elemptr = getelementptr inbounds [3 x i32], ptr %_0, i64 0, i64 0
  store i32 10, ptr %elemptr, align 4
  %elemptr1 = getelementptr inbounds [3 x i32], ptr %_0, i64 0, i64 1
  store i32 20, ptr %elemptr1, align 4
  %elemptr2 = getelementptr inbounds [3 x i32], ptr %_0, i64 0, i64 2
  store i32 12, ptr %elemptr2, align 4
...
bb2:                                              ; preds = %bb1
  %load3 = load i64, ptr %_2, align 8
  %elemptr4 = getelementptr inbounds [3 x i32], ptr %_0, i64 0, i64 %load3
  %idx = load i32, ptr %elemptr4, align 4
  %load5 = load i32, ptr %_1, align 4
  %add = add i32 %load5, %idx
  store i32 %add, ptr %_1, align 4
  br label %bb3

bb3:                                              ; preds = %bb2
  %load6 = load i64, ptr %_2, align 8
  %add7 = add i64 %load6, 1
  store i64 %add7, ptr %_2, align 8
  br label %bb1

bb4:                                              ; preds = %bb1
  %load8 = load i32, ptr %_1, align 4
  ret i32 %load8
}
