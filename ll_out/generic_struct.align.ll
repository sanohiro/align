...
%"Pair$bool" = type { i1, i1 }
%"Two$i32$bool" = type { i32, i1 }

; Function Attrs: nounwind
define i32 @sum(%"Pair$i32" %0) #0 {
bb0:
  %_0 = alloca %"Pair$i32", align 4
  store %"Pair$i32" %0, ptr %_0, align 4
  %fldptr = getelementptr inbounds %"Pair$i32", ptr %_0, i32 0, i32 0
  %fld = load i32, ptr %fldptr, align 4
  %fldptr1 = getelementptr inbounds %"Pair$i32", ptr %_0, i32 0, i32 1
...
bb0:
  %_0 = alloca %"Pair$i32", align 4
  %_1 = alloca %"Pair$bool", align 1
  %_2 = alloca %"Two$i32$bool", align 4
  %_3 = alloca i1, align 1
  %call = call i32 @ident(i32 40)
  %fldptr = getelementptr inbounds %"Pair$i32", ptr %_0, i32 0, i32 0
  store i32 %call, ptr %fldptr, align 4
  %call1 = call i32 @ident(i32 2)
  %fldptr2 = getelementptr inbounds %"Pair$i32", ptr %_0, i32 0, i32 1
  store i32 %call1, ptr %fldptr2, align 4
  %fldptr3 = getelementptr inbounds %"Pair$bool", ptr %_1, i32 0, i32 0
  store i1 true, ptr %fldptr3, align 1
  %fldptr4 = getelementptr inbounds %"Pair$bool", ptr %_1, i32 0, i32 1
  store i1 false, ptr %fldptr4, align 1
  %call5 = call i32 @ident(i32 0)
  %fldptr6 = getelementptr inbounds %"Two$i32$bool", ptr %_2, i32 0, i32 0
  store i32 %call5, ptr %fldptr6, align 4
  %fldptr7 = getelementptr inbounds %"Two$i32$bool", ptr %_2, i32 0, i32 1
  store i1 false, ptr %fldptr7, align 1
  %fldptr8 = getelementptr inbounds %"Pair$bool", ptr %_1, i32 0, i32 0
  %fld = load i1, ptr %fldptr8, align 1
  br i1 %fld, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %fldptr9 = getelementptr inbounds %"Two$i32$bool", ptr %_2, i32 0, i32 1
  %fld10 = load i1, ptr %fldptr9, align 1
  %not = xor i1 %fld10, true
  store i1 %not, ptr %_3, align 1
  br label %bb3
...
bb3:                                              ; preds = %bb2, %bb1
  %load = load i1, ptr %_3, align 1
  br i1 %load, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %load11 = load %"Pair$i32", ptr %_0, align 4
  %call12 = call i32 @sum(%"Pair$i32" %load11)
  ret i32 %call12
