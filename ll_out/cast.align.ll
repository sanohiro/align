...
bb0:
  ...
  %_9 = alloca double, align 8
  %_10 = alloca i32, align 4
  store i32 300, ptr %_0, align 4
  %load = load i32, ptr %_0, align 4
  %cast = sext i32 %load to i64
  store i64 %cast, ptr %_1, align 8
  %load1 = load i64, ptr %_1, align 8
  %mul = mul i64 %load1, 1000000
  store i64 %mul, ptr %_2, align 8
  %load2 = load i64, ptr %_2, align 8
  %cast3 = trunc i64 %load2 to i32
  store i32 %cast3, ptr %_3, align 4
  store double 3.900000e+00, ptr %_4, align 8
  %load4 = load double, ptr %_4, align 8
  %intr = call i32 @llvm.fptosi.sat.i32.f64(double %load4)
  store i32 %intr, ptr %_5, align 4
  store i64 65, ptr %_6, align 8
  %load5 = load i64, ptr %_6, align 8
  %cast6 = trunc i64 %load5 to i32
  store i32 %cast6, ptr %_7, align 4
  %load7 = load i32, ptr %_7, align 4
  store i32 %load7, ptr %_8, align 4
  store double 1.000000e+20, ptr %_9, align 8
  %load8 = load double, ptr %_9, align 8
  %intr9 = call i32 @llvm.fptosi.sat.i32.f64(double %load8)
  store i32 %intr9, ptr %_10, align 4
  %load10 = load i32, ptr %_3, align 4
  %sub = sub i32 %load10, 299999997
  %load11 = load i32, ptr %_5, align 4
  %add = add i32 %sub, %load11
  %load12 = load i32, ptr %_8, align 4
  %add13 = add i32 %add, %load12
  %sub14 = sub i32 %add13, 65
  %load15 = load i32, ptr %_10, align 4
  %sub16 = sub i32 %load15, 2147483647
  %add17 = add i32 %sub14, %sub16
  ret i32 %add17
}
