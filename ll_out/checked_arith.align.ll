...
bb0:
  ...
  %load = load i8, ptr %_0, align 1
  %add = add i8 %load, 100
  %sext = sext i8 %add to i64
  call void @align_rt_print_i64(i64 %sext)
  %load1 = load i8, ptr %_0, align 1
  %intr = call i8 @llvm.sadd.sat.i8(i8 %load1, i8 100)
  %sext2 = sext i8 %intr to i64
  call void @align_rt_print_i64(i64 %sext2)
  store i32 2000000000, ptr %_1, align 4
  %load3 = load i32, ptr %_1, align 4
  %load4 = load i32, ptr %_1, align 4
  %intr5 = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %load3, i32 %load4)
  %res = extractvalue { i32, i1 } %intr5, 0
  %of = extractvalue { i32, i1 } %intr5, 1
  %tag = select i1 %of, i8 0, i8 1
  %tag6 = insertvalue { i8, i32 } zeroinitializer, i8 %tag, 0
  %val = insertvalue { i8, i32 } %tag6, i32 %res, 1
  %tag7 = extractvalue { i8, i32 } %val, 0
  %issome = icmp eq i8 %tag7, 1
  br i1 %issome, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %some = extractvalue { i8, i32 } %val, 1
...
bb3:                                              ; preds = %bb2, %bb1
  ...
  %sext9 = sext i32 %load8 to i64
  call void @align_rt_print_i64(i64 %sext9)
  %load10 = load i32, ptr %_1, align 4
  %intr11 = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %load10, i32 5)
  %res12 = extractvalue { i32, i1 } %intr11, 0
  %of13 = extractvalue { i32, i1 } %intr11, 1
  %tag14 = select i1 %of13, i8 0, i8 1
  %tag15 = insertvalue { i8, i32 } zeroinitializer, i8 %tag14, 0
  %val16 = insertvalue { i8, i32 } %tag15, i32 %res12, 1
  %tag17 = extractvalue { i8, i32 } %val16, 0
  %issome18 = icmp eq i8 %tag17, 1
  br i1 %issome18, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %some19 = extractvalue { i8, i32 } %val16, 1
  store i32 %some19, ptr %_3, align 4
  br label %bb6
...
bb6:                                              ; preds = %bb5, %bb4
  %load20 = load i32, ptr %_3, align 4
  %sext21 = sext i32 %load20 to i64
  call void @align_rt_print_i64(i64 %sext21)
