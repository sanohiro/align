...
define { i8, i64, { i32, i32 } } @fetch(i64 %0) #0 {
bb0:
  %_0 = alloca i64, align 8
  store i64 %0, ptr %_0, align 8
  %load = load i64, ptr %_0, align 8
  %lt = icmp slt i64 %load, 0
  br i1 %lt, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  ret { i8, i64, { i32, i32 } } { i8 1, i64 0, { i32, i32 } { i32 3, i32 2 } }
...
bb3:                                              ; preds = %bb2
  ...
  %mul = mul i64 %load1, 10
  %ok = insertvalue { i8, i64, { i32, i32 } } zeroinitializer, i64 %mul, 1
  ret { i8, i64, { i32, i32 } } %ok
}

; Function Attrs: nounwind
define { i8, i32, { i32, i32 } } @align_main() #0 {
bb0:
  %waitr = alloca { i8, i32, { i32, i32 } }, align 8
  %_0 = alloca ptr, align 8
  %_1 = alloca ptr, align 8
  %tg = call ptr @align_rt_tg_begin()
  %slot = call ptr @align_rt_tg_alloc(ptr %tg, i64 8, i64 8)
  %errslot = call ptr @align_rt_tg_alloc(ptr %tg, i64 8, i64 4)
  call void @align_rt_tg_register(ptr %tg, ptr @"tramp$i64$f", ptr @"main$lambda0$fnval", ptr null, ptr %slot, ptr %errslot)
  store ptr %slot, ptr %_0, align 8
  %slot1 = call ptr @align_rt_tg_alloc(ptr %tg, i64 8, i64 8)
  %errslot2 = call ptr @align_rt_tg_alloc(ptr %tg, i64 8, i64 4)
  call void @align_rt_tg_register(ptr %tg, ptr @"tramp$i64$f", ptr @"main$lambda1$fnval", ptr null, ptr %slot1, ptr %errslot2)
  store ptr %slot1, ptr %_1, align 8
  %tgwait = call ptr @align_rt_tg_wait(ptr %tg)
  %iserr = icmp ne ptr %tgwait, null
  br i1 %iserr, label %waiterr, label %waitok

bb1:                                              ; preds = %waitjoin
  %ok = extractvalue { i8, i32, { i32, i32 } } %waitres, 1
  %load = load ptr, ptr %_0, align 8
  %boxget = load i64, ptr %load, align 8
  %load3 = load ptr, ptr %_1, align 8
  %boxget4 = load i64, ptr %load3, align 8
  %add = add i64 %boxget, %boxget4
  call void @align_rt_print_i64(i64 %add)
  call void @align_rt_tg_end(ptr %tg)
  ret { i8, i32, { i32, i32 } } zeroinitializer

bb2:                                              ; preds = %waitjoin
  %err = extractvalue { i8, i32, { i32, i32 } } %waitres, 2
  %err5 = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %err, 2
  %0 = call ptr @align_rt_tg_wait(ptr %tg)
  call void @align_rt_tg_end(ptr %tg)
  ret { i8, i32, { i32, i32 } } %err5

waiterr:                                          ; preds = %bb0
  %errv = load { i32, i32 }, ptr %tgwait, align 4
  %eerr = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %errv, 2
  store { i8, i32, { i32, i32 } } %eerr, ptr %waitr, align 4
  br label %waitjoin

waitok:                                           ; preds = %bb0
  store { i8, i32, { i32, i32 } } zeroinitializer, ptr %waitr, align 4
  br label %waitjoin

waitjoin:                                         ; preds = %waitok, %waiterr
  %waitres = load { i8, i32, { i32, i32 } }, ptr %waitr, align 4
  %tag = extractvalue { i8, i32, { i32, i32 } } %waitres, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb1, label %bb2
}

; Function Attrs: nounwind
define { i8, i64, { i32, i32 } } @"main$lambda0"() #0 {
bb0:
  %call = call { i8, i64, { i32, i32 } } @fetch(i64 3)
  ret { i8, i64, { i32, i32 } } %call
}

; Function Attrs: nounwind
define { i8, i64, { i32, i32 } } @"main$lambda1"() #0 {
bb0:
  %call = call { i8, i64, { i32, i32 } } @fetch(i64 4)
  ret { i8, i64, { i32, i32 } } %call
}
...
; Function Attrs: nounwind
define { i8, i64, { i32, i32 } } @"main$lambda0$fnval"(ptr %0) #0 {
entry:
  %r = call { i8, i64, { i32, i32 } } @"main$lambda0"()
  ret { i8, i64, { i32, i32 } } %r
}

; Function Attrs: nounwind
define { i8, i64, { i32, i32 } } @"main$lambda1$fnval"(ptr %0) #0 {
entry:
  %r = call { i8, i64, { i32, i32 } } @"main$lambda1"()
  ret { i8, i64, { i32, i32 } } %r
}

; Function Attrs: nounwind
define i32 @"tramp$i64$f"(ptr %0, ptr %1, ptr %2, ptr %3) #0 {
entry:
  %r = call { i8, i64, { i32, i32 } } %0(ptr %1)
  %tag = extractvalue { i8, i64, { i32, i32 } } %r, 0
  %ok = extractvalue { i8, i64, { i32, i32 } } %r, 1
  %err = extractvalue { i8, i64, { i32, i32 } } %r, 2
  %iserr = icmp eq i8 %tag, 1
  br i1 %iserr, label %err1, label %ok2

err1:                                             ; preds = %entry
  store { i32, i32 } %err, ptr %3, align 4
  ret i32 1

ok2:                                              ; preds = %entry
  store i64 %ok, ptr %2, align 8
  ret i32 0
}
