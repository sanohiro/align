...
@str = constant [5 x i8] c"hello"
@str.1 = constant [5 x i8] c"world"

; Function Attrs: nounwind
define { { ptr, i64 }, { ptr, i64 } } @labels() #0 {
bb0:
  ret { { ptr, i64 }, { ptr, i64 } } { { ptr, i64 } { ptr @str, i64 5 }, { ptr, i64 } { ptr @str.1, i64 5 } }
}
...
bb0:
  ...
  %call = call { { ptr, i64 }, { ptr, i64 } } @labels()
  ...
  %load2 = load { ptr, i64 }, ptr %_1, align 8
  %len3 = extractvalue { ptr, i64 } %load2, 1
  %add = add i64 %len, %len3
  %eq = icmp eq i64 %add, 10
