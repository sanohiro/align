...
bb0:
  ...
  %_1 = alloca %Point, align 4
  %_2 = alloca %Point, align 4
  %_3 = alloca %Point, align 4
  %rawptr = call ptr @align_rt_alloc(i64 8)
  store ptr %rawptr, ptr %_0, align 8
  %load = load ptr, ptr %_0, align 8
  %fldptr = getelementptr inbounds %Point, ptr %_3, i32 0, i32 0
  store i32 30, ptr %fldptr, align 4
  %fldptr1 = getelementptr inbounds %Point, ptr %_3, i32 0, i32 1
  store i32 12, ptr %fldptr1, align 4
  %load2 = load %Point, ptr %_3, align 4
  %rawelem = getelementptr i8, ptr %load, i64 0
  store %Point %load2, ptr %rawelem, align 1
  %load3 = load ptr, ptr %_0, align 8
  %rawelem4 = getelementptr i8, ptr %load3, i64 0
  %rawval = load %Point, ptr %rawelem4, align 1
  store %Point %rawval, ptr %_1, align 4
  %load5 = load ptr, ptr %_0, align 8
  %call = call ptr @memset(ptr %load5, i32 0, i64 8)
  %load6 = load ptr, ptr %_0, align 8
  %rawelem7 = getelementptr i8, ptr %load6, i64 0
  %rawval8 = load %Point, ptr %rawelem7, align 1
  store %Point %rawval8, ptr %_2, align 4
  %load9 = load ptr, ptr %_0, align 8
  call void @align_rt_free(ptr %load9)
  %fldptr10 = getelementptr inbounds %Point, ptr %_1, i32 0, i32 0
  %fld = load i32, ptr %fldptr10, align 4
  %fldptr11 = getelementptr inbounds %Point, ptr %_1, i32 0, i32 1
  %fld12 = load i32, ptr %fldptr11, align 4
  %add = add i32 %fld, %fld12
  %fldptr13 = getelementptr inbounds %Point, ptr %_2, i32 0, i32 0
  %fld14 = load i32, ptr %fldptr13, align 4
  %add15 = add i32 %add, %fld14
  %fldptr16 = getelementptr inbounds %Point, ptr %_2, i32 0, i32 1
  %fld17 = load i32, ptr %fldptr16, align 4
  %add18 = add i32 %add15, %fld17
  ret i32 %add18
}
