...
bb0:
  ...
  %_1 = alloca { i32, %Point }, align 4
  %_2 = alloca i32, align 4
  %_3 = alloca i32, align 4
  %_4 = alloca %Point, align 4
  %_5 = alloca i32, align 4
  %_6 = alloca %Point, align 4
  %_7 = alloca i32, align 4
  %_8 = alloca i32, align 4
  %call = call i32 @ident(i32 40)
  %pl = insertvalue { i32, i32 } zeroinitializer, i32 %call, 1
  store { i32, i32 } %pl, ptr %_0, align 4
  %fldptr = getelementptr inbounds %Point, ptr %_6, i32 0, i32 0
  store i32 0, ptr %fldptr, align 4
  %fldptr1 = getelementptr inbounds %Point, ptr %_6, i32 0, i32 1
  store i32 2, ptr %fldptr1, align 4
  %load = load %Point, ptr %_6, align 4
  %pl2 = insertvalue { i32, %Point } zeroinitializer, %Point %load, 1
  store { i32, %Point } %pl2, ptr %_1, align 4
  %load3 = load { i32, i32 }, ptr %_0, align 4
  %tag = extractvalue { i32, i32 } %load3, 0
  %tageq = icmp eq i32 %tag, 0
  br i1 %tageq, label %bb2, label %bb3

bb1:                                              ; preds = %bb3, %bb2
  %load4 = load i32, ptr %_7, align 4
  store i32 %load4, ptr %_3, align 4
  %load5 = load { i32, %Point }, ptr %_1, align 4
  %tag6 = extractvalue { i32, %Point } %load5, 0
  %tageq7 = icmp eq i32 %tag6, 0
  br i1 %tageq7, label %bb5, label %bb6

bb2:                                              ; preds = %bb0
  %pl8 = extractvalue { i32, i32 } %load3, 1
  store i32 %pl8, ptr %_2, align 4
  %load9 = load i32, ptr %_2, align 4
  store i32 %load9, ptr %_7, align 4
  br label %bb1
...
bb4:                                              ; preds = %bb6, %bb5
  %load10 = load i32, ptr %_8, align 4
  store i32 %load10, ptr %_5, align 4
  %load11 = load i32, ptr %_3, align 4
  %load12 = load i32, ptr %_5, align 4
  %add = add i32 %load11, %load12
  ret i32 %add

bb5:                                              ; preds = %bb1
  %pl13 = extractvalue { i32, %Point } %load5, 1
  store %Point %pl13, ptr %_4, align 4
  %fldptr14 = getelementptr inbounds %Point, ptr %_4, i32 0, i32 0
  %fld = load i32, ptr %fldptr14, align 4
  %fldptr15 = getelementptr inbounds %Point, ptr %_4, i32 0, i32 1
  %fld16 = load i32, ptr %fldptr15, align 4
  %add17 = add i32 %fld, %fld16
  store i32 %add17, ptr %_8, align 4
  br label %bb4
