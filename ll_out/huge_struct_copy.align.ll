...
%Hot = type { double, double, double, double }

; Function Attrs: nounwind
define double @step(%Hot %0) #0 {
bb0:
  %_0 = alloca %Hot, align 8
  store %Hot %0, ptr %_0, align 8
  %fldptr = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 0
  %fld = load double, ptr %fldptr, align 8
  %fldptr1 = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 2
  %fld2 = load double, ptr %fldptr1, align 8
  %fadd = fadd double %fld, %fld2
  %fldptr3 = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 1
  %fld4 = load double, ptr %fldptr3, align 8
  %fldptr5 = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 3
  %fld6 = load double, ptr %fldptr5, align 8
  %fadd7 = fadd double %fld4, %fld6
  %fadd8 = fadd double %fadd, %fadd7
  ret double %fadd8
}
...
bb0:
  ...
  %fldptr = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 0
  store double 1.000000e+00, ptr %fldptr, align 8
  %fldptr1 = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 1
  store double 2.000000e+00, ptr %fldptr1, align 8
  %fldptr2 = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 2
  store double 5.000000e-01, ptr %fldptr2, align 8
  %fldptr3 = getelementptr inbounds %Hot, ptr %_0, i32 0, i32 3
  store double 5.000000e-01, ptr %fldptr3, align 8
  %load = load %Hot, ptr %_0, align 8
  %call = call double @step(%Hot %load)
  store double %call, ptr %_1, align 8
  %load4 = load double, ptr %_1, align 8
