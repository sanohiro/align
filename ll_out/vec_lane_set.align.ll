...
bb0:
  ...
  store <4 x i32> <i32 10, i32 20, i32 30, i32 40>, ptr %_0, align 16
  %load = load <4 x i32>, ptr %_0, align 16
  %vins = insertelement <4 x i32> %load, i32 99, i32 1
  store <4 x i32> %vins, ptr %_0, align 16
  %load1 = load <4 x i32>, ptr %_0, align 16
  %vins2 = insertelement <4 x i32> %load1, i32 1, i32 3
  store <4 x i32> %vins2, ptr %_0, align 16
  %load3 = load <4 x i32>, ptr %_0, align 16
  %vext = extractelement <4 x i32> %load3, i32 0
  %load4 = load <4 x i32>, ptr %_0, align 16
  %vext5 = extractelement <4 x i32> %load4, i32 1
  %add = add i32 %vext, %vext5
  %load6 = load <4 x i32>, ptr %_0, align 16
  %vext7 = extractelement <4 x i32> %load6, i32 2
  %add8 = add i32 %add, %vext7
  %load9 = load <4 x i32>, ptr %_0, align 16
  %vext10 = extractelement <4 x i32> %load9, i32 3
  %add11 = add i32 %add8, %vext10
  ret i32 %add11
}
