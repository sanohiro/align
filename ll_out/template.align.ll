...
@str.2 = constant [6 x i8] c"Hello "
@str.3 = constant [8 x i8] c", score="
@str.4 = constant [6 x i8] c", tag="
...
bb0:
  ...
  store { ptr, i64 } { ptr @str, i64 5 }, ptr %_0, align 8
  store i64 40, ptr %_1, align 8
  %load = load { ptr, i64 }, ptr %_0, align 8
  %load1 = load i64, ptr %_1, align 8
  %add = add i64 %load1, 2
  %load2 = load { ptr, i64 }, ptr %_0, align 8
  %b = call ptr @align_rt_builder_new(ptr null, i64 0)
  %p = extractvalue { ptr, i64 } %load2, 0
  %l = extractvalue { ptr, i64 } %load2, 1
  call void @align_rt_builder_write(ptr %b, ptr %p, i64 %l)
  call void @align_rt_builder_write(ptr %b, ptr @str.1, i64 1)
  %s = call { ptr, i64 } @align_rt_builder_finish(ptr %b)
  %b3 = call ptr @align_rt_builder_new(ptr null, i64 0)
  call void @align_rt_builder_write(ptr %b3, ptr @str.2, i64 6)
  %p4 = extractvalue { ptr, i64 } %load, 0
  %l5 = extractvalue { ptr, i64 } %load, 1
  call void @align_rt_builder_write(ptr %b3, ptr %p4, i64 %l5)
  call void @align_rt_builder_write(ptr %b3, ptr @str.3, i64 8)
  call void @align_rt_builder_write_int(ptr %b3, i64 %add)
  call void @align_rt_builder_write(ptr %b3, ptr @str.4, i64 6)
  %p6 = extractvalue { ptr, i64 } %s, 0
  %l7 = extractvalue { ptr, i64 } %s, 1
  call void @align_rt_builder_write(ptr %b3, ptr %p6, i64 %l7)
  %s8 = call { ptr, i64 } @align_rt_builder_finish(ptr %b3)
  %sptr = extractvalue { ptr, i64 } %s8, 0
  %slen = extractvalue { ptr, i64 } %s8, 1
