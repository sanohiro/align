...
%User = type { i64, { ptr, i64 }, i1 }

@str = constant [3 x i8] c"a\22b"
@str.1 = constant [1 x i8] c"{"
@str.2 = constant [5 x i8] c"\22id\22:"
@str.3 = constant [8 x i8] c",\22name\22:"
@str.4 = constant [10 x i8] c",\22active\22:"
@str.5 = constant [1 x i8] c"}"

; Function Attrs: nounwind
define i32 @main() #0 {
bb0:
  %_0 = alloca %User, align 8
  %fldptr = getelementptr inbounds %User, ptr %_0, i32 0, i32 0
  store i64 7, ptr %fldptr, align 8
  %fldptr1 = getelementptr inbounds %User, ptr %_0, i32 0, i32 1
  store { ptr, i64 } { ptr @str, i64 3 }, ptr %fldptr1, align 8
  %fldptr2 = getelementptr inbounds %User, ptr %_0, i32 0, i32 2
  store i1 true, ptr %fldptr2, align 1
  %fldptr3 = getelementptr inbounds %User, ptr %_0, i32 0, i32 0
  %fld = load i64, ptr %fldptr3, align 8
  %fldptr4 = getelementptr inbounds %User, ptr %_0, i32 0, i32 1
  %fld5 = load { ptr, i64 }, ptr %fldptr4, align 8
  %fldptr6 = getelementptr inbounds %User, ptr %_0, i32 0, i32 2
  %fld7 = load i1, ptr %fldptr6, align 1
  %b = call ptr @align_rt_builder_new(ptr null, i64 0)
  call void @align_rt_builder_write(ptr %b, ptr @str.1, i64 1)
  call void @align_rt_builder_write(ptr %b, ptr @str.2, i64 5)
  call void @align_rt_builder_write_int(ptr %b, i64 %fld)
  call void @align_rt_builder_write(ptr %b, ptr @str.3, i64 8)
  %jp = extractvalue { ptr, i64 } %fld5, 0
  %jl = extractvalue { ptr, i64 } %fld5, 1
  call void @align_rt_builder_write_json_str(ptr %b, ptr %jp, i64 %jl)
  call void @align_rt_builder_write(ptr %b, ptr @str.4, i64 10)
  %bext = zext i1 %fld7 to i32
  call void @align_rt_builder_write_bool(ptr %b, i32 %bext)
  call void @align_rt_builder_write(ptr %b, ptr @str.5, i64 1)
  %s = call { ptr, i64 } @align_rt_builder_finish(ptr %b)
  %sptr = extractvalue { ptr, i64 } %s, 0
  %slen = extractvalue { ptr, i64 } %s, 1
  call void @align_rt_print_str(ptr %sptr, i64 %slen)
  ret i32 0
}
