...
bb0:
  ...
  %box = call ptr @align_rt_arena_alloc(ptr %arena, i64 4, i64 4)
  store i32 42, ptr %box, align 4
  store ptr %box, ptr %_0, align 8
  %load = load ptr, ptr %_0, align 8
  store ptr %load, ptr %_1, align 8
  %load1 = load ptr, ptr %_1, align 8
  %boxget = load i32, ptr %load1, align 4
  call void @align_rt_arena_end(ptr %arena)
  store i32 %boxget, ptr %_2, align 4
