...
bb0:
  ...
  %vadd = add <4 x i32> %load, %load1
  store <4 x i32> %vadd, ptr %_2, align 16
  %load2 = load <4 x i32>, ptr %_2, align 16
  %load3 = load <4 x i32>, ptr %_1, align 16
  %vmul = mul <4 x i32> %load2, %load3
  store <4 x i32> %vmul, ptr %_3, align 16
  %load4 = load <4 x i32>, ptr %_3, align 16
  %vext = extractelement <4 x i32> %load4, i32 2
  ret i32 %vext
}
