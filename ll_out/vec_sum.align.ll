...
bb0:
  ...
  %hs0 = extractelement <4 x i32> %load, i32 0
  %hsl = extractelement <4 x i32> %load, i32 1
  %hsadd = add i32 %hs0, %hsl
  %hsl1 = extractelement <4 x i32> %load, i32 2
  %hsadd2 = add i32 %hsadd, %hsl1
  %hsl3 = extractelement <4 x i32> %load, i32 3
  %hsadd4 = add i32 %hsadd2, %hsl3
  ret i32 %hsadd4
}
