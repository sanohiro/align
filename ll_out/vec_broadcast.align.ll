...
bb0:
  ...
  %_3 = alloca <4 x i1>, align 1
  %_4 = alloca <4 x i32>, align 16
  store <4 x i32> <i32 1, i32 2, i32 3, i32 4>, ptr %_0, align 16
  %load = load <4 x i32>, ptr %_0, align 16
  %vadd = add <4 x i32> <i32 10, i32 10, i32 10, i32 10>, %load
  store <4 x i32> %vadd, ptr %_1, align 16
  %load1 = load <4 x i32>, ptr %_0, align 16
  %vsub = sub <4 x i32> <i32 20, i32 20, i32 20, i32 20>, %load1
  store <4 x i32> %vsub, ptr %_2, align 16
  %load2 = load <4 x i32>, ptr %_0, align 16
  %vicmp = icmp slt <4 x i32> <i32 2, i32 2, i32 2, i32 2>, %load2
  store <4 x i1> %vicmp, ptr %_3, align 1
  %load3 = load <4 x i1>, ptr %_3, align 1
  %load4 = load <4 x i32>, ptr %_1, align 16
  %load5 = load <4 x i32>, ptr %_2, align 16
  %vsel = select <4 x i1> %load3, <4 x i32> %load4, <4 x i32> %load5
  store <4 x i32> %vsel, ptr %_4, align 16
  %load6 = load <4 x i32>, ptr %_4, align 16
  %vext = extractelement <4 x i32> %load6, i32 0
  %load7 = load <4 x i32>, ptr %_4, align 16
  %vext8 = extractelement <4 x i32> %load7, i32 1
  %add = add i32 %vext, %vext8
  %load9 = load <4 x i32>, ptr %_4, align 16
  %vext10 = extractelement <4 x i32> %load9, i32 2
  %add11 = add i32 %add, %vext10
  %load12 = load <4 x i32>, ptr %_4, align 16
  %vext13 = extractelement <4 x i32> %load12, i32 3
  %add14 = add i32 %add11, %vext13
  ret i32 %add14
}
