...
define { i8, i32, { i32, i32 } } @save(i32 %0) #0 {
bb0:
...
bb1:                                              ; preds = %bb0
  ret { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } { i32 1, i32 0 } }
...
bb3:                                              ; preds = %bb2
  ...
  %ok = insertvalue { i8, i32, { i32, i32 } } zeroinitializer, i32 %load1, 1
  ret { i8, i32, { i32, i32 } } %ok
}

; Function Attrs: nounwind
define { i8, i32, { i32, i32 } } @run() #0 {
bb0:
  %_0 = alloca i32, align 4
  %_1 = alloca { i8, i32, { i32, i32 } }, align 4
  %_2 = alloca i32, align 4
  %_3 = alloca { i32, i32 }, align 4
  %_4 = alloca i32, align 4
  %_5 = alloca i32, align 4
  %call = call { i8, i32, { i32, i32 } } @save(i32 10)
  %tag = extractvalue { i8, i32, { i32, i32 } } %call, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %ok = extractvalue { i8, i32, { i32, i32 } } %call, 1
  store i32 %ok, ptr %_0, align 4
  %call1 = call { i8, i32, { i32, i32 } } @save(i32 32)
  store { i8, i32, { i32, i32 } } %call1, ptr %_1, align 4
  %load = load { i8, i32, { i32, i32 } }, ptr %_1, align 4
  %tag2 = extractvalue { i8, i32, { i32, i32 } } %load, 0
  %isok3 = icmp eq i8 %tag2, 0
  br i1 %isok3, label %bb4, label %bb5

bb2:                                              ; preds = %bb0
  %err = extractvalue { i8, i32, { i32, i32 } } %call, 2
  %err4 = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %err, 2
  ret { i8, i32, { i32, i32 } } %err4

bb3:                                              ; preds = %bb5, %bb4
  %load5 = load i32, ptr %_5, align 4
  store i32 %load5, ptr %_4, align 4
  %load6 = load i32, ptr %_0, align 4
  %load7 = load i32, ptr %_4, align 4
  %add = add i32 %load6, %load7
  %ok8 = insertvalue { i8, i32, { i32, i32 } } zeroinitializer, i32 %add, 1
  ret { i8, i32, { i32, i32 } } %ok8

bb4:                                              ; preds = %bb1
  %ok9 = extractvalue { i8, i32, { i32, i32 } } %load, 1
  store i32 %ok9, ptr %_2, align 4
  %load10 = load i32, ptr %_2, align 4
  store i32 %load10, ptr %_5, align 4
  br label %bb3

bb5:                                              ; preds = %bb1
  %err11 = extractvalue { i8, i32, { i32, i32 } } %load, 2
  store { i32, i32 } %err11, ptr %_3, align 4
...
bb0:
  ...
  %_2 = alloca i32, align 4
  %call = call { i8, i32, { i32, i32 } } @run()
  %tag = extractvalue { i8, i32, { i32, i32 } } %call, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb2, label %bb3

bb1:                                              ; preds = %bb3, %bb2
  %load = load i32, ptr %_2, align 4
  ret i32 %load
...
bb3:                                              ; preds = %bb0
  %err = extractvalue { i8, i32, { i32, i32 } } %call, 2
  store { i32, i32 } %err, ptr %_1, align 4
  store i32 99, ptr %_2, align 4
  br label %bb1
}
