...
define i64 @chunk_sum({ ptr, i64 } %0) #0 {
bb0:
...
bb2:                                              ; preds = %bb1
  ...
  %slcidx = getelementptr inbounds i64, ptr %ptr, i64 %load2
  %slcload = load i64, ptr %slcidx, align 8
  %load3 = load i64, ptr %_1, align 8
  %add = add i64 %load3, %slcload
  store i64 %add, ptr %_1, align 8
  br label %bb3

bb3:                                              ; preds = %bb2
  %load4 = load i64, ptr %_2, align 8
  %add5 = add i64 %load4, 1
  store i64 %add5, ptr %_2, align 8
  br label %bb1

bb4:                                              ; preds = %bb1
  %load6 = load i64, ptr %_1, align 8
  ret i64 %load6
}
...
bb0:
  ...
  %_1 = alloca [6 x i64], align 8
  %_2 = alloca i64, align 8
  %_3 = alloca i64, align 8
  %elemptr = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 0
  store i64 1, ptr %elemptr, align 8
  %elemptr1 = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 1
  store i64 2, ptr %elemptr1, align 8
  %elemptr2 = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 2
  store i64 3, ptr %elemptr2, align 8
  %elemptr3 = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 3
  store i64 4, ptr %elemptr3, align 8
  %elemptr4 = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 4
  store i64 5, ptr %elemptr4, align 8
  %elemptr5 = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 5
  store i64 6, ptr %elemptr5, align 8
  %slcbase = getelementptr inbounds [6 x i64], ptr %_1, i64 0, i64 0
  %slcptr = insertvalue { ptr, i64 } poison, ptr %slcbase, 0
  %slclen = insertvalue { ptr, i64 } %slcptr, i64 6, 1
  ...
  %inptr = extractvalue { ptr, i64 } %chunks, 0
  %incnt = extractvalue { ptr, i64 } %chunks, 1
  %obuf = call ptr @align_rt_par_map(ptr %inptr, i64 %incnt, i64 16, i64 8, ptr @"chunk_sum$parthunk")
  %pmptr = insertvalue { ptr, i64 } poison, ptr %obuf, 0
  %pmlen = insertvalue { ptr, i64 } %pmptr, i64 %incnt, 1
  %dropvalptr = extractvalue { ptr, i64 } %chunks, 0
  call void @align_rt_free(ptr %dropvalptr)
  %len = extractvalue { ptr, i64 } %pmlen, 1
  store i64 0, ptr %_2, align 8
...
bb1:                                              ; preds = %bb3, %bb0
  ...
  %lt = icmp slt i64 %load, %len
  br i1 %lt, label %bb2, label %bb4

bb2:                                              ; preds = %bb1
  %load6 = load i64, ptr %_3, align 8
  %ptr = extractvalue { ptr, i64 } %pmlen, 0
  %slcidx = getelementptr inbounds i64, ptr %ptr, i64 %load6
  %slcload = load i64, ptr %slcidx, align 8
  %load7 = load i64, ptr %_2, align 8
  %add = add i64 %load7, %slcload
  store i64 %add, ptr %_2, align 8
  br label %bb3

bb3:                                              ; preds = %bb2
  %load8 = load i64, ptr %_3, align 8
  %add9 = add i64 %load8, 1
  store i64 %add9, ptr %_3, align 8
  br label %bb1

bb4:                                              ; preds = %bb1
  %load10 = load i64, ptr %_2, align 8
  %dropvalptr11 = extractvalue { ptr, i64 } %pmlen, 0
  call void @align_rt_free(ptr %dropvalptr11)
  store i64 %load10, ptr %_0, align 8
...
; Function Attrs: nounwind
define void @"chunk_sum$parthunk"(ptr %0, ptr %1) #0 {
entry:
  %x = load { ptr, i64 }, ptr %0, align 8
  %r = call i64 @chunk_sum({ ptr, i64 } %x)
  store i64 %r, ptr %1, align 8
  ret void
}
