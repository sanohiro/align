...
@str = constant [5 x i8] c"align"
@str.1 = constant [5 x i8] c"align"
@str.2 = constant [5 x i8] c"align"
@str.3 = constant [5 x i8] c"align"
@str.4 = constant [5 x i8] c"align"
@str.5 = constant [4 x i8] c"rust"
...
bb0:
  ...
  %_3 = alloca i1, align 1
  %_4 = alloca i1, align 1
  %_5 = alloca i1, align 1
  %_6 = alloca i1, align 1
  %hash = call i64 @align_rt_hash64(ptr @str, i64 5)
  store i64 %hash, ptr %_0, align 8
  %hash1 = call { i64, i64 } @align_rt_hash128(ptr @str.1, i64 5)
  store { i64, i64 } %hash1, ptr %_1, align 8
  %load = load { i64, i64 }, ptr %_1, align 8
  %tupidx = extractvalue { i64, i64 } %load, 0
  %load2 = load i64, ptr %_0, align 8
  %eq = icmp eq i64 %tupidx, %load2
  store i1 %eq, ptr %_2, align 1
  %hash3 = call i64 @align_rt_hash64(ptr @str.2, i64 5)
  %hash4 = call i64 @align_rt_hash64(ptr @str.3, i64 5)
  %eq5 = icmp eq i64 %hash3, %hash4
  store i1 %eq5, ptr %_3, align 1
  %hash6 = call i64 @align_rt_hash64(ptr @str.4, i64 5)
  %hash7 = call i64 @align_rt_hash64(ptr @str.5, i64 4)
  %ne = icmp ne i64 %hash6, %hash7
  store i1 %ne, ptr %_4, align 1
  %load8 = load i1, ptr %_2, align 1
  br i1 %load8, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %load9 = load i1, ptr %_3, align 1
  store i1 %load9, ptr %_6, align 1
  br label %bb3

bb2:                                              ; preds = %bb0
  store i1 false, ptr %_6, align 1
  br label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %load10 = load i1, ptr %_6, align 1
  br i1 %load10, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %load11 = load i1, ptr %_4, align 1
  store i1 %load11, ptr %_5, align 1
  br label %bb6

bb5:                                              ; preds = %bb3
  store i1 false, ptr %_5, align 1
  br label %bb6

bb6:                                              ; preds = %bb5, %bb4
  %load12 = load i1, ptr %_5, align 1
  br i1 %load12, label %bb7, label %bb8
