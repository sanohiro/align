...
bb0:
  ...
  store { ptr, ptr } { ptr @"add$fnval", ptr null }, ptr %_0, align 8
  %load = load { ptr, ptr }, ptr %_0, align 8
  %cf = extractvalue { ptr, ptr } %load, 0
  %ce = extractvalue { ptr, ptr } %load, 1
  %icall = call i64 %cf(ptr %ce, i64 10, i64 3)
  call void @align_rt_print_i64(i64 %icall)
  store { ptr, ptr } { ptr @"sub$fnval", ptr null }, ptr %_0, align 8
  %load1 = load { ptr, ptr }, ptr %_0, align 8
  %cf2 = extractvalue { ptr, ptr } %load1, 0
  %ce3 = extractvalue { ptr, ptr } %load1, 1
  %icall4 = call i64 %cf2(ptr %ce3, i64 10, i64 3)
  call void @align_rt_print_i64(i64 %icall4)
  store { ptr, ptr } { ptr @"main$lambda0$fnval", ptr null }, ptr %_1, align 8
  %load5 = load { ptr, ptr }, ptr %_1, align 8
  %cf6 = extractvalue { ptr, ptr } %load5, 0
  %ce7 = extractvalue { ptr, ptr } %load5, 1
  %icall8 = call i64 %cf6(ptr %ce7, i64 21)
  call void @align_rt_print_i64(i64 %icall8)
  store i64 100, ptr %_2, align 8
  %load9 = load i64, ptr %_2, align 8
  %capg = getelementptr inbounds { i64 }, ptr %clos_env, i32 0, i32 0
  store i64 %load9, ptr %capg, align 8
  %ce10 = insertvalue { ptr, ptr } { ptr @"main$lambda1$clos", ptr null }, ptr %clos_env, 1
  store { ptr, ptr } %ce10, ptr %_3, align 8
  %load11 = load { ptr, ptr }, ptr %_3, align 8
  %cf12 = extractvalue { ptr, ptr } %load11, 0
  %ce13 = extractvalue { ptr, ptr } %load11, 1
  %icall14 = call i64 %cf12(ptr %ce13, i64 5)
  call void @align_rt_print_i64(i64 %icall14)
...
; Function Attrs: nounwind
define i64 @"add$fnval"(ptr %0, i64 %1, i64 %2) #0 {
entry:
  %r = call i64 @add(i64 %1, i64 %2)
  ret i64 %r
}
...
; Function Attrs: nounwind
define i64 @"sub$fnval"(ptr %0, i64 %1, i64 %2) #0 {
entry:
  %r = call i64 @sub(i64 %1, i64 %2)
  ret i64 %r
}
