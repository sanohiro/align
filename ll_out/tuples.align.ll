...
define { i32, i32 } @divmod(i32 %0, i32 %1) #0 {
bb0:
  ...
  %eq = icmp eq i32 %load1, 0
  br i1 %eq, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  call void @align_rt_div_fail()
  unreachable

bb2:                                              ; preds = %bb0
  %eq2 = icmp eq i32 %load1, -1
  %sel = select i1 %eq2, i32 1, i32 %load1
  %sdiv = sdiv i32 %load, %sel
  %sub = sub i32 0, %load
  %sel3 = select i1 %eq2, i32 %sub, i32 %sdiv
  %load4 = load i32, ptr %_0, align 4
  %load5 = load i32, ptr %_1, align 4
  %eq6 = icmp eq i32 %load5, 0
  br i1 %eq6, label %bb3, label %bb4
...
bb4:                                              ; preds = %bb2
  %eq7 = icmp eq i32 %load5, -1
  %sel8 = select i1 %eq7, i32 1, i32 %load5
  %srem = srem i32 %load4, %sel8
  %sel9 = select i1 %eq7, i32 0, i32 %srem
  %tup = insertvalue { i32, i32 } poison, i32 %sel3, 0
  %tup10 = insertvalue { i32, i32 } %tup, i32 %sel9, 1
  ret { i32, i32 } %tup10
}
...
bb0:
  %_0 = alloca i32, align 4
  %_1 = alloca i32, align 4
  %call = call { i32, i32 } @divmod(i32 17, i32 5)
  %tupidx = extractvalue { i32, i32 } %call, 0
  store i32 %tupidx, ptr %_0, align 4
  %tupidx1 = extractvalue { i32, i32 } %call, 1
  store i32 %tupidx1, ptr %_1, align 4
  %load = load i32, ptr %_0, align 4
  %mul = mul i32 %load, 10
  %load2 = load i32, ptr %_1, align 4
  %add = add i32 %mul, %load2
  ret i32 %add
}
