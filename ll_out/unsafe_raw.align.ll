...
bb0:
  ...
  %rawptr = call ptr @align_rt_alloc(i64 16)
  store ptr %rawptr, ptr %_0, align 8
  %load = load ptr, ptr %_0, align 8
  %rawelem = getelementptr i8, ptr %load, i64 0
  store i64 42, ptr %rawelem, align 1
  %load1 = load ptr, ptr %_0, align 8
  %rawelem2 = getelementptr i8, ptr %load1, i64 8
  store i64 99, ptr %rawelem2, align 1
  %load3 = load ptr, ptr %_0, align 8
  %rawelem4 = getelementptr i8, ptr %load3, i64 0
  %rawval = load i64, ptr %rawelem4, align 1
  store i64 %rawval, ptr %_1, align 8
  %load5 = load ptr, ptr %_0, align 8
  %rawelem6 = getelementptr i8, ptr %load5, i64 8
  %rawval7 = load i64, ptr %rawelem6, align 1
  store i64 %rawval7, ptr %_2, align 8
  %load8 = load ptr, ptr %_0, align 8
  call void @align_rt_free(ptr %load8)
  %load9 = load i64, ptr %_1, align 8
  %load10 = load i64, ptr %_2, align 8
  %add = add i64 %load9, %load10
