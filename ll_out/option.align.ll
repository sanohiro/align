...
define { i8, i32 } @choose(i1 %0) #0 {
bb0:
  %_0 = alloca i1, align 1
  store i1 %0, ptr %_0, align 1
  %load = load i1, ptr %_0, align 1
  br i1 %load, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  ret { i8, i32 } { i8 1, i32 7 }
...
bb0:
  ...
  %call = call { i8, i32 } @choose(i1 true)
  %tag = extractvalue { i8, i32 } %call, 0
  %issome = icmp eq i8 %tag, 1
  br i1 %issome, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %some = extractvalue { i8, i32 } %call, 1
...
bb3:                                              ; preds = %bb2, %bb1
  ...
  store i32 %load, ptr %_0, align 4
  %call1 = call { i8, i32 } @choose(i1 false)
  %tag2 = extractvalue { i8, i32 } %call1, 0
  %issome3 = icmp eq i8 %tag2, 1
  br i1 %issome3, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %some4 = extractvalue { i8, i32 } %call1, 1
  store i32 %some4, ptr %_3, align 4
  br label %bb6

bb5:                                              ; preds = %bb3
  store i32 99, ptr %_3, align 4
  br label %bb6

bb6:                                              ; preds = %bb5, %bb4
  %load5 = load i32, ptr %_3, align 4
  store i32 %load5, ptr %_1, align 4
