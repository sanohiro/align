...
define i32 @classify({ i8, i32, { i32, i32 } } %0) #0 {
bb0:
...
bb0:
  ...
  %_1 = alloca i32, align 4
  %call = call i32 @classify({ i8, i32, { i32, i32 } } { i8 0, i32 21, { i32, i32 } zeroinitializer })
  store i32 %call, ptr %_0, align 4
  %call1 = call i32 @classify({ i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } { i32 3, i32 1 } })
