...
bb0:
  ...
  %elemfield2 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 0, i32 2
  store i1 true, ptr %elemfield2, align 1
  %elemfield3 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 0
  store i32 99, ptr %elemfield3, align 4
  %elemfield4 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 1
  store i32 99, ptr %elemfield4, align 4
  %elemfield5 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 2
  store i1 false, ptr %elemfield5, align 1
  %elemfield6 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 0
  store i32 18, ptr %elemfield6, align 4
  %elemfield7 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 1
  store i32 4, ptr %elemfield7, align 4
  %elemfield8 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 2
  store i1 true, ptr %elemfield8, align 1
...
bb2:                                              ; preds = %bb1
  ...
  %elemfield10 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 %load9, i32 2
  ...
  %sel = select i1 %idxfld, i32 %call, i32 0
