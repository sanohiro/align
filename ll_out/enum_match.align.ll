...
define i32 @area({ i32, i32, i32, i32 } %0) #0 {
bb0:
  %_0 = alloca { i32, i32, i32, i32 }, align 4
  %_1 = alloca i32, align 4
  %_2 = alloca i32, align 4
  %_3 = alloca i32, align 4
  %_4 = alloca i32, align 4
  store { i32, i32, i32, i32 } %0, ptr %_0, align 4
  %load = load { i32, i32, i32, i32 }, ptr %_0, align 4
  %tag = extractvalue { i32, i32, i32, i32 } %load, 0
...
bb2:                                              ; preds = %bb0
  %pl = extractvalue { i32, i32, i32, i32 } %load, 1
  store i32 %pl, ptr %_1, align 4
  %load2 = load i32, ptr %_1, align 4
  %mul = mul i32 3, %load2
  %load3 = load i32, ptr %_1, align 4
  %mul4 = mul i32 %mul, %load3
  store i32 %mul4, ptr %_4, align 4
  br label %bb1

bb3:                                              ; preds = %bb0
  %tag5 = extractvalue { i32, i32, i32, i32 } %load, 0
  %tageq6 = icmp eq i32 %tag5, 1
  br i1 %tageq6, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %pl7 = extractvalue { i32, i32, i32, i32 } %load, 2
  store i32 %pl7, ptr %_2, align 4
  %pl8 = extractvalue { i32, i32, i32, i32 } %load, 3
  store i32 %pl8, ptr %_3, align 4
  %load9 = load i32, ptr %_2, align 4
  %load10 = load i32, ptr %_3, align 4
  %mul11 = mul i32 %load9, %load10
  store i32 %mul11, ptr %_4, align 4
  br label %bb1
...
define i32 @main() #0 {
bb0:
  %call = call i32 @area({ i32, i32, i32, i32 } { i32 1, i32 0, i32 3, i32 4 })
  %call1 = call i32 @area({ i32, i32, i32, i32 } { i32 2, i32 0, i32 0, i32 0 })
