...
define { i8, i32, { i32, i32 } } @open(i32 %0) #0 {
bb0:
...
bb1:                                              ; preds = %bb0
  ret { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }
...
bb3:                                              ; preds = %bb2
  ...
  %lt = icmp slt i32 %load1, 0
  br i1 %lt, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %load2 = load i32, ptr %_0, align 4
  %pl = insertvalue { i32, i32 } { i32 2, i32 0 }, i32 %load2, 1
  %err = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %pl, 2
  ret { i8, i32, { i32, i32 } } %err
...
bb6:                                              ; preds = %bb5
  ...
  %ok = insertvalue { i8, i32, { i32, i32 } } zeroinitializer, i32 %load3, 1
  ret { i8, i32, { i32, i32 } } %ok
}

; Function Attrs: nounwind
define i32 @exit_code({ i8, i32, { i32, i32 } } %0) #0 {
bb0:
  %_0 = alloca { i8, i32, { i32, i32 } }, align 4
  %_1 = alloca i32, align 4
  %_2 = alloca { i32, i32 }, align 4
  %_3 = alloca i32, align 4
  %_4 = alloca i32, align 4
  %_5 = alloca i32, align 4
  store { i8, i32, { i32, i32 } } %0, ptr %_0, align 4
  %load = load { i8, i32, { i32, i32 } }, ptr %_0, align 4
  %tag = extractvalue { i8, i32, { i32, i32 } } %load, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb2, label %bb3

bb1:                                              ; preds = %bb4, %bb2
  %load1 = load i32, ptr %_4, align 4
  ret i32 %load1

bb2:                                              ; preds = %bb0
  %ok = extractvalue { i8, i32, { i32, i32 } } %load, 1
  store i32 %ok, ptr %_1, align 4
  %load2 = load i32, ptr %_1, align 4
  store i32 %load2, ptr %_4, align 4
  br label %bb1

bb3:                                              ; preds = %bb0
  %err = extractvalue { i8, i32, { i32, i32 } } %load, 2
  store { i32, i32 } %err, ptr %_2, align 4
  %load3 = load { i32, i32 }, ptr %_2, align 4
  %tag4 = extractvalue { i32, i32 } %load3, 0
  %tageq = icmp eq i32 %tag4, 0
  br i1 %tageq, label %bb5, label %bb6

bb4:                                              ; preds = %bb8, %bb7, %bb5
  %load5 = load i32, ptr %_5, align 4
  store i32 %load5, ptr %_4, align 4
  br label %bb1
...
bb6:                                              ; preds = %bb3
  %tag6 = extractvalue { i32, i32 } %load3, 0
  %tageq7 = icmp eq i32 %tag6, 1
  br i1 %tageq7, label %bb7, label %bb8
...
bb8:                                              ; preds = %bb6
  %pl = extractvalue { i32, i32 } %load3, 1
  store i32 %pl, ptr %_3, align 4
  %load8 = load i32, ptr %_3, align 4
  store i32 %load8, ptr %_5, align 4
  br label %bb4
}
...
define i32 @main() #0 {
bb0:
  %call = call { i8, i32, { i32, i32 } } @open(i32 40)
  %call1 = call i32 @exit_code({ i8, i32, { i32, i32 } } %call)
  ret i32 %call1
}
