...
define double @area(double %0) #0 {
bb0:
  %_0 = alloca double, align 8
  store double %0, ptr %_0, align 8
  %load = load double, ptr %_0, align 8
  %load1 = load double, ptr %_0, align 8
  %fmul = fmul double %load, %load1
  %fmul2 = fmul double %fmul, 3.141590e+00
  ret double %fmul2
}
...
bb0:
  %_0 = alloca double, align 8
  %call = call double @area(double 2.000000e+00)
  store double %call, ptr %_0, align 8
  %load = load double, ptr %_0, align 8
  %fgt = fcmp ogt double %load, 1.200000e+01
  br i1 %fgt, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %load1 = load double, ptr %_0, align 8
  %flt = fcmp olt double %load1, 1.300000e+01
  br i1 %flt, label %bb4, label %bb5
