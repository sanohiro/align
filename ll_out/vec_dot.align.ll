...
bb0:
  ...
  store <4 x i32> <i32 1, i32 2, i32 3, i32 4>, ptr %_0, align 16
  store <4 x i32> <i32 10, i32 20, i32 30, i32 40>, ptr %_1, align 16
  %load = load <4 x i32>, ptr %_0, align 16
  %load1 = load <4 x i32>, ptr %_1, align 16
  %dotmul = mul <4 x i32> %load, %load1
  %hs0 = extractelement <4 x i32> %dotmul, i32 0
  %hsl = extractelement <4 x i32> %dotmul, i32 1
  %hsadd = add i32 %hs0, %hsl
  %hsl2 = extractelement <4 x i32> %dotmul, i32 2
  %hsadd3 = add i32 %hsadd, %hsl2
  %hsl4 = extractelement <4 x i32> %dotmul, i32 3
  %hsadd5 = add i32 %hsadd3, %hsl4
  ret i32 %hsadd5
}
