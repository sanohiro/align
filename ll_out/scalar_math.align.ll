...
bb0:
  ...
  store i32 -42, ptr %_0, align 4
  %load = load i32, ptr %_0, align 4
  %intr = call i32 @llvm.abs.i32(i32 %load, i1 false)
  %sext = sext i32 %intr to i64
  call void @align_rt_print_i64(i64 %sext)
  %intr1 = call i64 @llvm.smin.i64(i64 3, i64 7)
  call void @align_rt_print_i64(i64 %intr1)
  %intr2 = call i64 @llvm.smax.i64(i64 3, i64 7)
  call void @align_rt_print_i64(i64 %intr2)
  store double -2.500000e+00, ptr %_1, align 8
  %load3 = load double, ptr %_1, align 8
  %intr4 = call double @llvm.fabs.f64(double %load3)
  call void @align_rt_print_f64(double %intr4)
  %intr5 = call double @llvm.sqrt.f64(double 2.000000e+00)
  call void @align_rt_print_f64(double %intr5)
  %intr6 = call double @llvm.floor.f64(double 3.700000e+00)
  call void @align_rt_print_f64(double %intr6)
  %intr7 = call double @llvm.pow.f64(double 2.000000e+00, double 1.000000e+01)
  call void @align_rt_print_f64(double %intr7)
