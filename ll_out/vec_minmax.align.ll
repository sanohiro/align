...
bb0:
  ...
  store <4 x i32> <i32 30, i32 10, i32 40, i32 20>, ptr %_0, align 16
  %load = load <4 x i32>, ptr %_0, align 16
  %hm0 = extractelement <4 x i32> %load, i32 0
  %hml = extractelement <4 x i32> %load, i32 1
  %intr = call i32 @llvm.smax.i32(i32 %hm0, i32 %hml)
  %hml1 = extractelement <4 x i32> %load, i32 2
  %intr2 = call i32 @llvm.smax.i32(i32 %intr, i32 %hml1)
  %hml3 = extractelement <4 x i32> %load, i32 3
  %intr4 = call i32 @llvm.smax.i32(i32 %intr2, i32 %hml3)
  %load5 = load <4 x i32>, ptr %_0, align 16
  %hm06 = extractelement <4 x i32> %load5, i32 0
  %hml7 = extractelement <4 x i32> %load5, i32 1
  %intr8 = call i32 @llvm.smin.i32(i32 %hm06, i32 %hml7)
  %hml9 = extractelement <4 x i32> %load5, i32 2
  %intr10 = call i32 @llvm.smin.i32(i32 %intr8, i32 %hml9)
  %hml11 = extractelement <4 x i32> %load5, i32 3
  %intr12 = call i32 @llvm.smin.i32(i32 %intr10, i32 %hml11)
  %sub = sub i32 %intr4, %intr12
  ret i32 %sub
}
