...
@str = constant [0 x i8] zeroinitializer
@str.1 = constant [6 x i8] c"secret"
@str.2 = constant [2 x i8] c"ok"

; Function Attrs: nounwind
define { i8, i32, { i32, i32 } } @parse({ ptr, i64 } %0) #0 {
bb0:
  %_0 = alloca { ptr, i64 }, align 8
  store { ptr, i64 } %0, ptr %_0, align 8
  %load = load { ptr, i64 }, ptr %_0, align 8
  %pa = extractvalue { ptr, i64 } %load, 0
  %la = extractvalue { ptr, i64 } %load, 1
  %streq = call i32 @align_rt_str_eq(ptr %pa, i64 %la, ptr @str, i64 0)
  %eq = icmp ne i32 %streq, 0
...
bb3:                                              ; preds = %bb2
  %load1 = load { ptr, i64 }, ptr %_0, align 8
  %pa2 = extractvalue { ptr, i64 } %load1, 0
  %la3 = extractvalue { ptr, i64 } %load1, 1
  %streq4 = call i32 @align_rt_str_eq(ptr %pa2, i64 %la3, ptr @str.1, i64 6)
  %eq5 = icmp ne i32 %streq4, 0
  br i1 %eq5, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  ret { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } { i32 2, i32 0 } }

bb5:                                              ; preds = %bb3
  br label %bb6

bb6:                                              ; preds = %bb5
  ret { i8, i32, { i32, i32 } } { i8 0, i32 42, { i32, i32 } zeroinitializer }
}
...
bb0:
  ...
  %call = call { i8, i32, { i32, i32 } } @parse({ ptr, i64 } { ptr @str.2, i64 2 })
...
bb2:                                              ; preds = %bb0
  ...
  %err1 = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %err, 2
  ret { i8, i32, { i32, i32 } } %err1
}
