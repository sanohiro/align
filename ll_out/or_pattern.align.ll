...
bb0:
  ...
  br i1 %tageq, label %bb2, label %bb4

bb1:                                              ; preds = %bb6, %bb5, %bb2
...
bb3:                                              ; preds = %bb4
  %tag2 = extractvalue { i32 } %load, 0
  %tageq3 = icmp eq i32 %tag2, 2
  br i1 %tageq3, label %bb5, label %bb6

bb4:                                              ; preds = %bb0
  %tag4 = extractvalue { i32 } %load, 0
  %tageq5 = icmp eq i32 %tag4, 1
  br i1 %tageq5, label %bb2, label %bb3

bb5:                                              ; preds = %bb3
  store i32 2, ptr %_1, align 4
  br label %bb1
...
define i32 @main() #0 {
bb0:
  %call = call i32 @rank({ i32 } { i32 1 })
  %call1 = call i32 @rank({ i32 } { i32 2 })
  %add = add i32 %call, %call1
  %call2 = call i32 @rank({ i32 } { i32 3 })
