...
bb0:
  ...
  %_2 = alloca <4 x float>, align 16
  %_3 = alloca <4 x float>, align 16
  store <4 x float> <float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.000000e+00>, ptr %_0, align 16
  store <4 x float> <float 1.000000e+01, float 1.000000e+01, float 1.000000e+01, float 1.000000e+01>, ptr %_1, align 16
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, ptr %_2, align 16
  %load = load <4 x float>, ptr %_0, align 16
  %load1 = load <4 x float>, ptr %_1, align 16
  %load2 = load <4 x float>, ptr %_2, align 16
  %intr = call <4 x float> @llvm.fma.v4f32(<4 x float> %load, <4 x float> %load1, <4 x float> %load2)
  store <4 x float> %intr, ptr %_3, align 16
  %load3 = load <4 x float>, ptr %_3, align 16
  %vext = extractelement <4 x float> %load3, i32 0
  %load4 = load <4 x float>, ptr %_3, align 16
  %vext5 = extractelement <4 x float> %load4, i32 1
  %fadd = fadd float %vext, %vext5
  %load6 = load <4 x float>, ptr %_3, align 16
  %vext7 = extractelement <4 x float> %load6, i32 2
  %fadd8 = fadd float %fadd, %vext7
  %load9 = load <4 x float>, ptr %_3, align 16
  %vext10 = extractelement <4 x float> %load9, i32 3
  %fadd11 = fadd float %fadd8, %vext10
  %intr12 = call i32 @llvm.fptosi.sat.i32.f32(float %fadd11)
  ret i32 %intr12
}
