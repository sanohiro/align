...
define i32 @main() #0 {
bb0:
  %_0 = alloca [8 x i64], align 64
  %_1 = alloca <4 x i64>, align 32
  %_2 = alloca <4 x i64>, align 32
  %_3 = alloca <4 x i64>, align 32
  %elemptr = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 0
  store i64 1, ptr %elemptr, align 8
  %elemptr1 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 1
  store i64 2, ptr %elemptr1, align 8
  %elemptr2 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 2
  store i64 3, ptr %elemptr2, align 8
  %elemptr3 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 3
  store i64 4, ptr %elemptr3, align 8
  %elemptr4 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 4
  store i64 5, ptr %elemptr4, align 8
  %elemptr5 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 5
  store i64 6, ptr %elemptr5, align 8
  %elemptr6 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 6
  store i64 7, ptr %elemptr6, align 8
  %elemptr7 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 7
  store i64 8, ptr %elemptr7, align 8
  %slcbase = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 0
  %slcptr = insertvalue { ptr, i64 } poison, ptr %slcbase, 0
  %slclen = insertvalue { ptr, i64 } %slcptr, i64 8, 1
  %len = extractvalue { ptr, i64 } %slclen, 1
  %gt = icmp sgt i64 0, %len
  %gt8 = icmp sgt i64 %len, %len
  %or = or i1 false, %gt
  %or9 = or i1 %or, %gt8
  br i1 %or9, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  call void @align_rt_range_fail(i64 0, i64 %len, i64 %len)
  unreachable

bb2:                                              ; preds = %bb0
  %sub = sub i64 %len, 0
  %subptr = extractvalue { ptr, i64 } %slclen, 0
  %subgep = getelementptr inbounds i64, ptr %subptr, i64 0
  %subvptr = insertvalue { ptr, i64 } poison, ptr %subgep, 0
  %subvlen = insertvalue { ptr, i64 } %subvptr, i64 %sub, 1
  %len10 = extractvalue { ptr, i64 } %subvlen, 1
  %gt11 = icmp sgt i64 4, %len10
  %or12 = or i1 false, %gt11
  br i1 %or12, label %bb3, label %bb4

bb3:                                              ; preds = %bb2
  call void @align_rt_range_fail(i64 0, i64 4, i64 %len10)
  unreachable

bb4:                                              ; preds = %bb2
  %vlbuf = extractvalue { ptr, i64 } %subvlen, 0
  %vloadgep = getelementptr inbounds i64, ptr %vlbuf, i64 0
  %vload = load <4 x i64>, ptr %vloadgep, align 64
  store <4 x i64> %vload, ptr %_1, align 32
  %slcbase13 = getelementptr inbounds [8 x i64], ptr %_0, i64 0, i64 0
  %slcptr14 = insertvalue { ptr, i64 } poison, ptr %slcbase13, 0
  %slclen15 = insertvalue { ptr, i64 } %slcptr14, i64 8, 1
  %len16 = extractvalue { ptr, i64 } %slclen15, 1
  %gt17 = icmp sgt i64 0, %len16
  %gt18 = icmp sgt i64 %len16, %len16
  %or19 = or i1 false, %gt17
  %or20 = or i1 %or19, %gt18
  br i1 %or20, label %bb5, label %bb6

bb5:                                              ; preds = %bb4
  call void @align_rt_range_fail(i64 0, i64 %len16, i64 %len16)
  unreachable

bb6:                                              ; preds = %bb4
  %sub21 = sub i64 %len16, 0
  %subptr22 = extractvalue { ptr, i64 } %slclen15, 0
  %subgep23 = getelementptr inbounds i64, ptr %subptr22, i64 0
  %subvptr24 = insertvalue { ptr, i64 } poison, ptr %subgep23, 0
  %subvlen25 = insertvalue { ptr, i64 } %subvptr24, i64 %sub21, 1
  %len26 = extractvalue { ptr, i64 } %subvlen25, 1
  %gt27 = icmp sgt i64 8, %len26
  %or28 = or i1 false, %gt27
  br i1 %or28, label %bb7, label %bb8

bb7:                                              ; preds = %bb6
  call void @align_rt_range_fail(i64 4, i64 8, i64 %len26)
  unreachable

bb8:                                              ; preds = %bb6
  %vlbuf29 = extractvalue { ptr, i64 } %subvlen25, 0
  %vloadgep30 = getelementptr inbounds i64, ptr %vlbuf29, i64 4
  %vload31 = load <4 x i64>, ptr %vloadgep30, align 8
  store <4 x i64> %vload31, ptr %_2, align 32
  %load = load <4 x i64>, ptr %_1, align 32
  %load32 = load <4 x i64>, ptr %_2, align 32
  %vadd = add <4 x i64> %load, %load32
  store <4 x i64> %vadd, ptr %_3, align 32
  %load33 = load <4 x i64>, ptr %_3, align 32
  %vext = extractelement <4 x i64> %load33, i32 0
  %load34 = load <4 x i64>, ptr %_3, align 32
  %vext35 = extractelement <4 x i64> %load34, i32 1
  %add = add i64 %vext, %vext35
  %load36 = load <4 x i64>, ptr %_3, align 32
  %vext37 = extractelement <4 x i64> %load36, i32 2
  %add38 = add i64 %add, %vext37
  %load39 = load <4 x i64>, ptr %_3, align 32
  %vext40 = extractelement <4 x i64> %load39, i32 3
  %add41 = add i64 %add38, %vext40
  %cast = trunc i64 %add41 to i32
  ret i32 %cast
}
