...
bb0:
  ...
  store i32 10, ptr %_1, align 4
  %load = load i32, ptr %_0, align 4
  %load1 = load i32, ptr %_1, align 4
  %and = and i32 %load, %load1
  store i32 %and, ptr %_2, align 4
  %load2 = load i32, ptr %_0, align 4
  %load3 = load i32, ptr %_1, align 4
  %or = or i32 %load2, %load3
  store i32 %or, ptr %_3, align 4
  %load4 = load i32, ptr %_0, align 4
  %load5 = load i32, ptr %_1, align 4
  %xor = xor i32 %load4, %load5
  store i32 %xor, ptr %_4, align 4
  store i32 16, ptr %_5, align 4
  %load6 = load i32, ptr %_2, align 4
  %load7 = load i32, ptr %_3, align 4
  %add = add i32 %load6, %load7
  %load8 = load i32, ptr %_4, align 4
  %add9 = add i32 %add, %load8
  %load10 = load i32, ptr %_5, align 4
