...
define i32 @main() #0 {
bb0:
  %_0 = alloca <4 x float>, align 16
  %_1 = alloca <4 x float>, align 16
  %_2 = alloca <4 x i32>, align 16
  %_3 = alloca <4 x i32>, align 16
  %_4 = alloca <4 x i32>, align 16
  store <4 x float> <float 1.000000e+00, float 4.000000e+00, float 9.000000e+00, float 1.600000e+01>, ptr %_0, align 16
  %load = load <4 x float>, ptr %_0, align 16
  %intr = call <4 x float> @llvm.sqrt.v4f32(<4 x float> %load)
  store <4 x float> %intr, ptr %_1, align 16
  store <4 x i32> <i32 1, i32 5, i32 3, i32 8>, ptr %_2, align 16
  store <4 x i32> <i32 4, i32 2, i32 6, i32 7>, ptr %_3, align 16
  %load1 = load <4 x i32>, ptr %_2, align 16
  %load2 = load <4 x i32>, ptr %_3, align 16
  %intr3 = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %load1, <4 x i32> %load2)
  store <4 x i32> %intr3, ptr %_4, align 16
  %load4 = load <4 x float>, ptr %_1, align 16
  %vext = extractelement <4 x float> %load4, i32 0
  %load5 = load <4 x float>, ptr %_1, align 16
  %vext6 = extractelement <4 x float> %load5, i32 1
  %fadd = fadd float %vext, %vext6
  %load7 = load <4 x float>, ptr %_1, align 16
  %vext8 = extractelement <4 x float> %load7, i32 2
  %fadd9 = fadd float %fadd, %vext8
  %load10 = load <4 x float>, ptr %_1, align 16
  %vext11 = extractelement <4 x float> %load10, i32 3
  %fadd12 = fadd float %fadd9, %vext11
  %intr13 = call i32 @llvm.fptosi.sat.i32.f32(float %fadd12)
  %load14 = load <4 x i32>, ptr %_4, align 16
  %vext15 = extractelement <4 x i32> %load14, i32 0
  %add = add i32 %intr13, %vext15
  %load16 = load <4 x i32>, ptr %_4, align 16
  %vext17 = extractelement <4 x i32> %load16, i32 1
  %add18 = add i32 %add, %vext17
  %load19 = load <4 x i32>, ptr %_4, align 16
  %vext20 = extractelement <4 x i32> %load19, i32 2
  %add21 = add i32 %add18, %vext20
  %load22 = load <4 x i32>, ptr %_4, align 16
  %vext23 = extractelement <4 x i32> %load22, i32 3
  %add24 = add i32 %add21, %vext23
  ret i32 %add24
}
