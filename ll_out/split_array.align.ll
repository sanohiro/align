...
define { { ptr, i64 }, { ptr, i64 } } @split() #0 {
bb0:
  ...
  %elemptr = getelementptr inbounds [3 x i64], ptr %_2, i64 0, i64 0
  store i64 1, ptr %elemptr, align 8
  %elemptr1 = getelementptr inbounds [3 x i64], ptr %_2, i64 0, i64 1
  store i64 2, ptr %elemptr1, align 8
  %elemptr2 = getelementptr inbounds [3 x i64], ptr %_2, i64 0, i64 2
...
bb2:                                              ; preds = %bb1
  %load3 = load i64, ptr %_4, align 8
  %elemptr4 = getelementptr inbounds [3 x i64], ptr %_2, i64 0, i64 %load3
...
bb3:                                              ; preds = %bb2
  %load6 = load i64, ptr %_4, align 8
  %add7 = add i64 %load6, 1
  store i64 %add7, ptr %_4, align 8
  br label %bb1
...
bb4:                                              ; preds = %bb1
  ...
  %elemptr9 = getelementptr inbounds [2 x i64], ptr %_5, i64 0, i64 0
  store i64 10, ptr %elemptr9, align 8
  %elemptr10 = getelementptr inbounds [2 x i64], ptr %_5, i64 0, i64 1
...
bb6:                                              ; preds = %bb5
  ...
  %elemptr15 = getelementptr inbounds [2 x i64], ptr %_5, i64 0, i64 %load14
  %idx16 = load i64, ptr %elemptr15, align 8
  %load17 = load i64, ptr %_6, align 8
  %ptrstore18 = getelementptr inbounds i64, ptr %buf11, i64 %load17
  store i64 %idx16, ptr %ptrstore18, align 8
  %add19 = add i64 %load17, 1
  store i64 %add19, ptr %_6, align 8
  br label %bb7

bb7:                                              ; preds = %bb6
  %load20 = load i64, ptr %_7, align 8
  %add21 = add i64 %load20, 1
  store i64 %add21, ptr %_7, align 8
  br label %bb5

bb8:                                              ; preds = %bb5
  %load22 = load i64, ptr %_6, align 8
  ...
  %drop28 = load { ptr, i64 }, ptr %_1, align 8
  %dropptr29 = extractvalue { ptr, i64 } %drop28, 0
  call void @align_rt_free(ptr %dropptr29)
  ret { { ptr, i64 }, { ptr, i64 } } %tup27
}
...
bb0:
  ...
  store { ptr, i64 } zeroinitializer, ptr %_0, align 8
  store { ptr, i64 } zeroinitializer, ptr %_1, align 8
  %call = call { { ptr, i64 }, { ptr, i64 } } @split()
  %tupidx = extractvalue { { ptr, i64 }, { ptr, i64 } } %call, 0
  store { ptr, i64 } %tupidx, ptr %_0, align 8
  %tupidx1 = extractvalue { { ptr, i64 }, { ptr, i64 } } %call, 1
  store { ptr, i64 } %tupidx1, ptr %_1, align 8
...
bb1:                                              ; preds = %bb3, %bb0
  %load2 = load i64, ptr %_3, align 8
  %lt = icmp slt i64 %load2, %len
  br i1 %lt, label %bb2, label %bb4

bb2:                                              ; preds = %bb1
  %load3 = load i64, ptr %_3, align 8
  %ptr = extractvalue { ptr, i64 } %load, 0
  %slcidx = getelementptr inbounds i64, ptr %ptr, i64 %load3
  %slcload = load i64, ptr %slcidx, align 8
  %load4 = load i64, ptr %_2, align 8
  %add = add i64 %load4, %slcload
...
bb3:                                              ; preds = %bb2
  ...
  store i64 %add6, ptr %_3, align 8
  br label %bb1

bb4:                                              ; preds = %bb1
  %load7 = load i64, ptr %_2, align 8
  %load8 = load { ptr, i64 }, ptr %_1, align 8
...
bb5:                                              ; preds = %bb7, %bb4
  ...
  %lt11 = icmp slt i64 %load10, %len9
  br i1 %lt11, label %bb6, label %bb8

bb6:                                              ; preds = %bb5
  %load12 = load i64, ptr %_5, align 8
  %ptr13 = extractvalue { ptr, i64 } %load8, 0
  %slcidx14 = getelementptr inbounds i64, ptr %ptr13, i64 %load12
  %slcload15 = load i64, ptr %slcidx14, align 8
  %load16 = load i64, ptr %_4, align 8
  %add17 = add i64 %load16, %slcload15
  store i64 %add17, ptr %_4, align 8
  br label %bb7

bb7:                                              ; preds = %bb6
  %load18 = load i64, ptr %_5, align 8
  %add19 = add i64 %load18, 1
  store i64 %add19, ptr %_5, align 8
  br label %bb5

bb8:                                              ; preds = %bb5
  %load20 = load i64, ptr %_4, align 8
  %add21 = add i64 %load7, %load20
  call void @align_rt_print_i64(i64 %add21)
  %drop = load { ptr, i64 }, ptr %_0, align 8
  %dropptr = extractvalue { ptr, i64 } %drop, 0
  call void @align_rt_free(ptr %dropptr)
  %drop22 = load { ptr, i64 }, ptr %_1, align 8
  %dropptr23 = extractvalue { ptr, i64 } %drop22, 0
  call void @align_rt_free(ptr %dropptr23)
