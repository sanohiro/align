...
define { i8, i32, { i32, %Pos } } @parse(i32 %0) #0 {
bb0:
  %_0 = alloca i32, align 4
  %_1 = alloca %Pos, align 4
...
bb1:                                              ; preds = %bb0
  %fldptr = getelementptr inbounds %Pos, ptr %_1, i32 0, i32 0
  store i32 3, ptr %fldptr, align 4
  %fldptr1 = getelementptr inbounds %Pos, ptr %_1, i32 0, i32 1
  store i32 7, ptr %fldptr1, align 4
  %load2 = load %Pos, ptr %_1, align 4
  %pl = insertvalue { i32, %Pos } zeroinitializer, %Pos %load2, 1
  %err = insertvalue { i8, i32, { i32, %Pos } } { i8 1, i32 0, { i32, %Pos } zeroinitializer }, { i32, %Pos } %pl, 2
  ret { i8, i32, { i32, %Pos } } %err

bb2:                                              ; preds = %bb0
  br label %bb3

bb3:                                              ; preds = %bb2
  %load3 = load i32, ptr %_0, align 4
  %eq = icmp eq i32 %load3, 0
  br i1 %eq, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  ret { i8, i32, { i32, %Pos } } { i8 1, i32 0, { i32, %Pos } { i32 1, %Pos zeroinitializer } }

bb5:                                              ; preds = %bb3
  br label %bb6

bb6:                                              ; preds = %bb5
  %load4 = load i32, ptr %_0, align 4
  %mul = mul i32 %load4, 2
  %ok = insertvalue { i8, i32, { i32, %Pos } } zeroinitializer, i32 %mul, 1
  ret { i8, i32, { i32, %Pos } } %ok
}
...
bb0:
  %_0 = alloca i32, align 4
  %_1 = alloca { i32, %Pos }, align 4
  %_2 = alloca %Pos, align 4
  %_3 = alloca i32, align 4
  %_4 = alloca i32, align 4
  %call = call { i8, i32, { i32, %Pos } } @parse(i32 -1)
  %tag = extractvalue { i8, i32, { i32, %Pos } } %call, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb2, label %bb3

bb1:                                              ; preds = %bb4, %bb2
  %load = load i32, ptr %_3, align 4
  ret i32 %load

bb2:                                              ; preds = %bb0
  %ok = extractvalue { i8, i32, { i32, %Pos } } %call, 1
  store i32 %ok, ptr %_0, align 4
  %load1 = load i32, ptr %_0, align 4
  store i32 %load1, ptr %_3, align 4
  br label %bb1

bb3:                                              ; preds = %bb0
  %err = extractvalue { i8, i32, { i32, %Pos } } %call, 2
  store { i32, %Pos } %err, ptr %_1, align 4
  %load2 = load { i32, %Pos }, ptr %_1, align 4
  %tag3 = extractvalue { i32, %Pos } %load2, 0
  %tageq = icmp eq i32 %tag3, 0
  br i1 %tageq, label %bb5, label %bb6

bb4:                                              ; preds = %bb6, %bb5
  %load4 = load i32, ptr %_4, align 4
  store i32 %load4, ptr %_3, align 4
  br label %bb1

bb5:                                              ; preds = %bb3
  %pl = extractvalue { i32, %Pos } %load2, 1
  store %Pos %pl, ptr %_2, align 4
  %fldptr = getelementptr inbounds %Pos, ptr %_2, i32 0, i32 0
  %fld = load i32, ptr %fldptr, align 4
  %mul = mul i32 %fld, 10
  %fldptr5 = getelementptr inbounds %Pos, ptr %_2, i32 0, i32 1
  %fld6 = load i32, ptr %fldptr5, align 4
  %add = add i32 %mul, %fld6
  store i32 %add, ptr %_4, align 4
  br label %bb4

bb6:                                              ; preds = %bb3
  store i32 99, ptr %_4, align 4
  br label %bb4
}
