...
bb0:
  ...
  %_1 = alloca <4 x i1>, align 1
  store <4 x i32> <i32 70, i32 90, i32 60, i32 85>, ptr %_0, align 16
  %load = load <4 x i32>, ptr %_0, align 16
  %vicmp = icmp sgt <4 x i32> %load, <i32 80, i32 80, i32 80, i32 80>
  store <4 x i1> %vicmp, ptr %_1, align 1
  %load1 = load <4 x i32>, ptr %_0, align 16
  %load2 = load <4 x i1>, ptr %_1, align 1
  %swsel = select <4 x i1> %load2, <4 x i32> %load1, <4 x i32> zeroinitializer
  %hs0 = extractelement <4 x i32> %swsel, i32 0
  %hsl = extractelement <4 x i32> %swsel, i32 1
  %hsadd = add i32 %hs0, %hsl
  %hsl3 = extractelement <4 x i32> %swsel, i32 2
  %hsadd4 = add i32 %hsadd, %hsl3
  %hsl5 = extractelement <4 x i32> %swsel, i32 3
  %hsadd6 = add i32 %hsadd4, %hsl5
  ret i32 %hsadd6
}
