...
@str = constant [2 x i8] c"id"
@str.1 = constant [6 x i8] c"active"
@jfields = constant [2 x { ptr, i64, i32, i64 }] [{ ptr, i64, i32, i64 } { ptr @str, i64 2, i32 65544, i64 0 }, { ptr, i64, i32, i64 } { ptr @str.1, i64 6, i32 257, i64 8 }]
@jphf = constant [2 x i32] [i32 0, i32 1]
@str.2 = constant [34 x i8] c"{\22active\22: true, \22x\22: 9, \22id\22: 42}"
@str.3 = constant [1 x i8] c"{"
@str.4 = constant [5 x i8] c"\22id\22:"
@str.5 = constant [10 x i8] c",\22active\22:"
@str.6 = constant [1 x i8] c"}"

; Function Attrs: nounwind
define { i8, %User, { i32, i32 } } @parse({ ptr, i64 } %0) #0 {
bb0:
  %_0 = alloca { ptr, i64 }, align 8
  %_1 = alloca %User, align 8
  %_2 = alloca %User, align 8
  %_3 = alloca { i8, %User, { i32, i32 } }, align 8
  store { ptr, i64 } %0, ptr %_0, align 8
  %load = load { ptr, i64 }, ptr %_0, align 8
  store %User zeroinitializer, ptr %_2, align 8
  %jin_p = extractvalue { ptr, i64 } %load, 0
  %jin_l = extractvalue { ptr, i64 } %load, 1
  %jdec = call i32 @align_rt_json_decode(ptr %jin_p, i64 %jin_l, ptr @jfields, i64 2, ptr %_2, i64 16, ptr @jphf, i64 2, i64 8)
  %eq = icmp eq i32 %jdec, 0
  br i1 %eq, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %load1 = load %User, ptr %_2, align 8
  %ok = insertvalue { i8, %User, { i32, i32 } } zeroinitializer, %User %load1, 1
  store { i8, %User, { i32, i32 } } %ok, ptr %_3, align 8
  br label %bb3

bb2:                                              ; preds = %bb0
  %pl = insertvalue { i32, i32 } { i32 3, i32 0 }, i32 %jdec, 1
  %err = insertvalue { i8, %User, { i32, i32 } } { i8 1, %User zeroinitializer, { i32, i32 } zeroinitializer }, { i32, i32 } %pl, 2
  store { i8, %User, { i32, i32 } } %err, ptr %_3, align 8
  br label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %load2 = load { i8, %User, { i32, i32 } }, ptr %_3, align 8
  %tag = extractvalue { i8, %User, { i32, i32 } } %load2, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %ok3 = extractvalue { i8, %User, { i32, i32 } } %load2, 1
  store %User %ok3, ptr %_1, align 8
  %load4 = load %User, ptr %_1, align 8
  %ok5 = insertvalue { i8, %User, { i32, i32 } } zeroinitializer, %User %load4, 1
  ret { i8, %User, { i32, i32 } } %ok5

bb5:                                              ; preds = %bb3
  %err6 = extractvalue { i8, %User, { i32, i32 } } %load2, 2
  %err7 = insertvalue { i8, %User, { i32, i32 } } { i8 1, %User zeroinitializer, { i32, i32 } zeroinitializer }, { i32, i32 } %err6, 2
  ret { i8, %User, { i32, i32 } } %err7
}
...
bb0:
  ...
  %call = call { i8, %User, { i32, i32 } } @parse({ ptr, i64 } { ptr @str.2, i64 34 })
  %tag = extractvalue { i8, %User, { i32, i32 } } %call, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %ok = extractvalue { i8, %User, { i32, i32 } } %call, 1
  store %User %ok, ptr %_0, align 8
  %fldptr = getelementptr inbounds %User, ptr %_0, i32 0, i32 0
  %fld = load i64, ptr %fldptr, align 8
  call void @align_rt_print_i64(i64 %fld)
  %fldptr1 = getelementptr inbounds %User, ptr %_0, i32 0, i32 0
  %fld2 = load i64, ptr %fldptr1, align 8
  %fldptr3 = getelementptr inbounds %User, ptr %_0, i32 0, i32 1
  %fld4 = load i1, ptr %fldptr3, align 1
  %b = call ptr @align_rt_builder_new(ptr null, i64 0)
  call void @align_rt_builder_write(ptr %b, ptr @str.3, i64 1)
  call void @align_rt_builder_write(ptr %b, ptr @str.4, i64 5)
  call void @align_rt_builder_write_int(ptr %b, i64 %fld2)
  call void @align_rt_builder_write(ptr %b, ptr @str.5, i64 10)
  %bext = zext i1 %fld4 to i32
  call void @align_rt_builder_write_bool(ptr %b, i32 %bext)
  call void @align_rt_builder_write(ptr %b, ptr @str.6, i64 1)
...
bb2:                                              ; preds = %bb0
  %err = extractvalue { i8, %User, { i32, i32 } } %call, 2
  %err5 = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %err, 2
  ret { i8, i32, { i32, i32 } } %err5
}
