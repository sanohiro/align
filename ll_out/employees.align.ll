...
bb0:
  ...
  store i32 10, ptr %elemfield, align 4
  %elemfield1 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 0, i32 1
  store i1 true, ptr %elemfield1, align 1
  %elemfield2 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 0
  store i32 50, ptr %elemfield2, align 4
  %elemfield3 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 1
  store i1 false, ptr %elemfield3, align 1
  %elemfield4 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 0
  store i32 32, ptr %elemfield4, align 4
  %elemfield5 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 1
  store i1 true, ptr %elemfield5, align 1
...
bb2:                                              ; preds = %bb1
  ...
  %elemfield7 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 %load6, i32 1
  %idxfld = load i1, ptr %elemfield7, align 1
  %elemfield8 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 %load6, i32 0
  %idxfld9 = load i32, ptr %elemfield8, align 4
  %load10 = load i32, ptr %_1, align 4
  %sel = select i1 %idxfld, i32 %idxfld9, i32 0
  %add = add i32 %load10, %sel
...
bb4:                                              ; preds = %bb1
  %load13 = load i32, ptr %_1, align 4
  ret i32 %load13
}
