...
@str = constant [10 x i8] c"hello, C!\0A"
@str.1 = constant [5 x i8] c"match"
@str.2 = constant [5 x i8] c"match"
...
bb0:
  ...
  store { ptr, i64 } { ptr @str, i64 10 }, ptr %_0, align 8
  %load = load { ptr, i64 }, ptr %_0, align 8
  %load1 = load { ptr, i64 }, ptr %_0, align 8
  %len = extractvalue { ptr, i64 } %load1, 1
  %ffiptr = extractvalue { ptr, i64 } %load, 0
  %call = call i64 @write(i32 1, ptr %ffiptr, i64 %len)
  store { ptr, i64 } { ptr @str.1, i64 5 }, ptr %_1, align 8
  store { ptr, i64 } { ptr @str.2, i64 5 }, ptr %_2, align 8
  %load2 = load { ptr, i64 }, ptr %_1, align 8
  %load3 = load { ptr, i64 }, ptr %_2, align 8
  %load4 = load { ptr, i64 }, ptr %_1, align 8
  %len5 = extractvalue { ptr, i64 } %load4, 1
  %ffiptr6 = extractvalue { ptr, i64 } %load2, 0
  %ffiptr7 = extractvalue { ptr, i64 } %load3, 0
  %call8 = call i32 @memcmp(ptr %ffiptr6, ptr %ffiptr7, i64 %len5)
  %eq = icmp eq i32 %call8, 0
