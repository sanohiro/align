...
bb0:
  ...
  %call = call i32 @abs(i32 -7)
  store i32 %call, ptr %_0, align 4
  %rawptr = call ptr @align_rt_alloc(i64 4)
  store ptr %rawptr, ptr %_1, align 8
  %load = load ptr, ptr %_1, align 8
  %call1 = call ptr @memset(ptr %load, i32 0, i64 4)
  %load2 = load ptr, ptr %_1, align 8
  %call3 = call ptr @memset(ptr %load2, i32 1, i64 4)
  %load4 = load ptr, ptr %_1, align 8
  %rawelem = getelementptr i8, ptr %load4, i64 2
  %rawval = load i8, ptr %rawelem, align 1
  store i8 %rawval, ptr %_2, align 1
  %load5 = load ptr, ptr %_1, align 8
  call void @align_rt_free(ptr %load5)
  %load6 = load i32, ptr %_0, align 4
  %load7 = load i8, ptr %_2, align 1
  %cast = sext i8 %load7 to i32
  %add = add i32 %load6, %cast
  ret i32 %add
}
