...
@str = constant [12 x i8] c"hello, align"
@str.1 = constant [13 x i8] c"strings work!"

; Function Attrs: nounwind
define { ptr, i64 } @greeting() #0 {
bb0:
  ret { ptr, i64 } { ptr @str, i64 12 }
}

; Function Attrs: nounwind
define i32 @main() #0 {
bb0:
  %call = call { ptr, i64 } @greeting()
  %sptr = extractvalue { ptr, i64 } %call, 0
  %slen = extractvalue { ptr, i64 } %call, 1
  call void @align_rt_print_str(ptr %sptr, i64 %slen)
  call void @align_rt_print_str(ptr @str.1, i64 13)
  ret i32 0
}
