...
define { i32, i32 } @to_error({ i32 } %0) #0 {
bb0:
  %_0 = alloca { i32 }, align 4
  %_1 = alloca { i32, i32 }, align 4
  store { i32 } %0, ptr %_0, align 4
  %load = load { i32 }, ptr %_0, align 4
  %tag = extractvalue { i32 } %load, 0
  %tageq = icmp eq i32 %tag, 0
  br i1 %tageq, label %bb2, label %bb3

bb1:                                              ; preds = %bb3, %bb2
  %load1 = load { i32, i32 }, ptr %_1, align 4
  ret { i32, i32 } %load1

bb2:                                              ; preds = %bb0
  store { i32, i32 } { i32 1, i32 0 }, ptr %_1, align 4
  br label %bb1

bb3:                                              ; preds = %bb0
  store { i32, i32 } { i32 3, i32 22 }, ptr %_1, align 4
  br label %bb1
}

; Function Attrs: nounwind
define { i8, i32, { i32 } } @parse(i32 %0) #0 {
bb0:
  %_0 = alloca i32, align 4
  store i32 %0, ptr %_0, align 4
  %load = load i32, ptr %_0, align 4
...
bb1:                                              ; preds = %bb0
  ret { i8, i32, { i32 } } { i8 1, i32 0, { i32 } zeroinitializer }
...
bb3:                                              ; preds = %bb2
  ...
  %gt = icmp sgt i32 %load1, 100
  br i1 %gt, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  ret { i8, i32, { i32 } } { i8 1, i32 0, { i32 } { i32 1 } }
...
bb6:                                              ; preds = %bb5
  ...
  %ok = insertvalue { i8, i32, { i32 } } zeroinitializer, i32 %load2, 1
  ret { i8, i32, { i32 } } %ok
}
...
bb0:
  ...
  %call = call { i8, i32, { i32 } } @parse(i32 42)
  %tag = extractvalue { i8, i32, { i32 } } %call, 0
  %isok = icmp eq i8 %tag, 0
  br i1 %isok, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %ok = extractvalue { i8, i32, { i32 } } %call, 1
  %ok1 = insertvalue { i8, i32, { i32, i32 } } zeroinitializer, i32 %ok, 1
  store { i8, i32, { i32, i32 } } %ok1, ptr %_1, align 4
  br label %bb3

bb2:                                              ; preds = %bb0
  %err = extractvalue { i8, i32, { i32 } } %call, 2
  %icall = call { i32, i32 } @"to_error$fnval"(ptr null, { i32 } %err)
  %err2 = insertvalue { i8, i32, { i32, i32 } } { i8 1, i32 0, { i32, i32 } zeroinitializer }, { i32, i32 } %icall, 2
  store { i8, i32, { i32, i32 } } %err2, ptr %_1, align 4
  br label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %load = load { i8, i32, { i32, i32 } }, ptr %_1, align 4
  %tag3 = extractvalue { i8, i32, { i32, i32 } } %load, 0
  %isok4 = icmp eq i8 %tag3, 0
  br i1 %isok4, label %bb4, label %bb5

bb4:                                              ; preds = %bb3
  %ok5 = extractvalue { i8, i32, { i32, i32 } } %load, 1
  store i32 %ok5, ptr %_0, align 4
...
bb5:                                              ; preds = %bb3
  %err7 = extractvalue { i8, i32, { i32, i32 } } %load, 2
...
; Function Attrs: nounwind
define { i32, i32 } @"to_error$fnval"(ptr %0, { i32 } %1) #0 {
entry:
  %r = call { i32, i32 } @to_error({ i32 } %1)
  ret { i32, i32 } %r
}
