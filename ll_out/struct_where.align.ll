...
bb0:
  ...
  %gt = icmp sgt i32 %fld, 40
  br i1 %gt, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  %fldptr1 = getelementptr inbounds %Emp, ptr %_0, i32 0, i32 2
  %fld2 = load i1, ptr %fldptr1, align 1
  store i1 %fld2, ptr %_1, align 1
  br label %bb3

bb2:                                              ; preds = %bb0
  store i1 false, ptr %_1, align 1
  br label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %load = load i1, ptr %_1, align 1
  ret i1 %load
}
...
define i32 @main() #0 {
bb0:
  %_0 = alloca [3 x %Emp], align 4
  %_1 = alloca i32, align 4
  %_2 = alloca i64, align 8
  %elemfield = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 0, i32 0
  store i32 50, ptr %elemfield, align 4
  %elemfield1 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 0, i32 2
  store i1 true, ptr %elemfield1, align 1
  %elemfield2 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 0, i32 1
  store i32 20, ptr %elemfield2, align 4
  %elemfield3 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 0
  store i32 60, ptr %elemfield3, align 4
  %elemfield4 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 2
  store i1 false, ptr %elemfield4, align 1
  %elemfield5 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 1, i32 1
  store i32 99, ptr %elemfield5, align 4
  %elemfield6 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 0
  store i32 45, ptr %elemfield6, align 4
  %elemfield7 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 2
  store i1 true, ptr %elemfield7, align 1
  %elemfield8 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 2, i32 1
  store i32 22, ptr %elemfield8, align 4
  store i32 0, ptr %_1, align 4
  store i64 0, ptr %_2, align 8
  br label %bb1

bb1:                                              ; preds = %bb3, %bb0
  %load = load i64, ptr %_2, align 8
  %lt = icmp slt i64 %load, 3
  br i1 %lt, label %bb2, label %bb4

bb2:                                              ; preds = %bb1
  %load9 = load i64, ptr %_2, align 8
  %elemptr = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 %load9
  %idx = load %Emp, ptr %elemptr, align 4
  %call = call i1 @busy(%Emp %idx)
  %elemfield10 = getelementptr inbounds [3 x %Emp], ptr %_0, i64 0, i64 %load9, i32 1
  %idxfld = load i32, ptr %elemfield10, align 4
  %load11 = load i32, ptr %_1, align 4
  %sel = select i1 %call, i32 %idxfld, i32 0
  %add = add i32 %load11, %sel
  store i32 %add, ptr %_1, align 4
  br label %bb3

bb3:                                              ; preds = %bb2
  %load12 = load i64, ptr %_2, align 8
  %add13 = add i64 %load12, 1
  store i64 %add13, ptr %_2, align 8
  br label %bb1

bb4:                                              ; preds = %bb1
  %load14 = load i32, ptr %_1, align 4
  ret i32 %load14
}
